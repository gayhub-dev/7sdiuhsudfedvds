...
public final class ResponseParsers {
    ...
    public static final class CompleteMultipartUploadResponseParser extends AbstractResponseParser<CompleteMultipartUploadResult> {
        @Override // com.alibaba.sdk.android.oss.internal.AbstractResponseParser
        public CompleteMultipartUploadResult parseData(ResponseMessage responseMessage, CompleteMultipartUploadResult completeMultipartUploadResult) throws IOException {
    ...
    public static Exception parseResponseErrorXML(ResponseMessage responseMessage, boolean z6) throws XmlPullParserException, IOException {
        String strNextText;
        String strNextText2;
        String str;
        String str2;
        ...
        if (z6) {
            ...
            try {
                ...
                return new ClientException(e7.getMessage(), e7);

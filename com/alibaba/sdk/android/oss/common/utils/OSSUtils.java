...
public class OSSUtils {
    ...
    public static void assertTrue(boolean z6, String str) {
        if (!z6) {
    ...
    public static String buildBaseLogInfo(Context context) {
        StringBuilder sbM112a = C0413b.m112a("=====[device info]=====\n");
        StringBuilder sbM112a2 = C0413b.m112a("[INFO]: android_version：");
        sbM112a2.append(Build.VERSION.RELEASE);
        sbM112a2.append(NEW_LINE);
        sbM112a.append(sbM112a2.toString());
        sbM112a.append("[INFO]: mobile_model：" + Build.MODEL + NEW_LINE);
    ...
    public static String buildCanonicalizedResource(String str, String str2, Map<String, String> map) {
        String strM97a = ServiceReference.DELIMITER;
        if (str != null || str2 != null) {
            if (str2 == null) {
                strM97a = C0096a.m97a(ServiceReference.DELIMITER, str, ServiceReference.DELIMITER);
            } else {
                strM97a = ServiceReference.DELIMITER + str + ServiceReference.DELIMITER + str2;
            }
        }
        return buildCanonicalizedResource(strM97a, map);
    }

    public static String buildImagePersistentBody(String str, String str2, String str3) {
        StringBuilder sbM112a = C0413b.m112a("x-oss-process=");
        if (str3.startsWith("image/")) {
            sbM112a.append(str3);
        } else {
            sbM112a.append("image/");
            sbM112a.append(str3);
        }
        sbM112a.append("|sys/");
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            ...
            sbM112a.append("saveas,o_");
            sbM112a.append(strEncodeToString2);
            sbM112a.append(",b_");
            sbM112a.append(strEncodeToString);
        }
    ...
    public static String buildTriggerCallbackBody(Map<String, String> map, Map<String, String> map2) {
        StringBuilder sbM112a = C0413b.m112a("x-oss-process=trigger/callback,callback_");
        if (map != null && map.size() > 0) {
            sbM112a.append(Base64.encodeToString(new JSONObject(map).toString().getBytes(), 2));
        }
        sbM112a.append(",callback-var_");
        if (map2 != null && map2.size() > 0) {
            sbM112a.append(Base64.encodeToString(new JSONObject(map2).toString().getBytes(), 2));
        }
        return sbM112a.toString();
    }

    public static String buildXMLFromPartEtagList(List<PartETag> list) {
        StringBuilder sbM112a = C0413b.m112a("<CompleteMultipartUpload>\n");
        for (PartETag partETag : list) {
            sbM112a.append("<Part>\n");
            sbM112a.append("<PartNumber>" + partETag.getPartNumber() + "</PartNumber>\n");
            sbM112a.append("<ETag>" + partETag.getETag() + "</ETag>\n");
            sbM112a.append("</Part>\n");
        }
        sbM112a.append("</CompleteMultipartUpload>\n");
        return sbM112a.toString();
    }

    public static void checkChecksum(Long l7, Long l8, String str) throws InconsistentException {
        if (l7 != null && l8 != null && !l7.equals(l8)) {
            throw new InconsistentException(l7, l8, str);
        }
    }

    public static boolean checkParamRange(long j7, long j8, boolean z6, long j9, boolean z7) {
        return (z6 && z7) ? j8 <= j7 && j7 <= j9 : (!z6 || z7) ? (z6 || z7) ? j8 < j7 && j7 <= j9 : j8 < j7 && j7 < j9 : j8 <= j7 && j7 < j9;
    }
    ...
    public static void populateCopyObjectHeaders(CopyObjectRequest copyObjectRequest, Map<String, String> map) {
        StringBuilder sbM112a = C0413b.m112a(ServiceReference.DELIMITER);
        sbM112a.append(copyObjectRequest.getSourceBucketName());
        sbM112a.append(ServiceReference.DELIMITER);
        sbM112a.append(HttpUtil.urlEncode(copyObjectRequest.getSourceKey(), "utf-8"));
        map.put(OSSHeaders.COPY_OBJECT_SOURCE, sbM112a.toString());
    ...
    public static void signRequest(RequestMessage requestMessage) throws IOException {
        ...
        if (requestMessage.isAuthorizationRequired()) {
            ...
            boolean z6 = credentialProvider instanceof OSSFederationCredentialProvider;
            if (z6) {
            ...
            if (z6 || (credentialProvider instanceof OSSStsTokenCredentialProvider)) {

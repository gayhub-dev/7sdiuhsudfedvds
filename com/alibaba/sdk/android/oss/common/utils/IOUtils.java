...
public class IOUtils {
    ...
    public static String readStreamAsString(InputStream inputStream, String str) throws Throwable {
        ...
        try {
            ...
            while (true) {
                try {
                    int i7 = bufferedReader2.read(cArr);
                    if (i7 <= 0) {
    ...
    public static byte[] readStreamAsBytesArray(InputStream inputStream, int i7) throws IOException {
        int i8;
        if (inputStream == null) {
            return new byte[0];
        }
        ...
        while (true) {
            long j8 = i7;
            if (j7 >= j8 || (i8 = inputStream.read(bArr, 0, Math.min(2048, (int) (j8 - j7)))) <= -1) {
                break;
            }

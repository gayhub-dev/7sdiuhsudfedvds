...
public class ListPartsResult extends OSSResult {
    ...
    public void setMaxParts(int i7) {
        this.maxParts = i7;
    }

    public void setNextPartNumberMarker(int i7) {
        this.nextPartNumberMarker = i7;
    }

    public void setPartNumberMarker(int i7) {
        this.partNumberMarker = i7;
    }

...
public class JSONPResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object obj, MethodParameter methodParameter, MediaType mediaType, Class<? extends HttpMessageConverter<?>> cls, ServerHttpRequest serverHttpRequest, ServerHttpResponse serverHttpResponse) {
        ...
        String strMo34r = ((ServletServerHttpRequest) serverHttpRequest).getServletRequest().mo34r(responseJSONP.callback());
        if (!IOUtils.isValidJsonpQueryParam(strMo34r)) {
            if (this.logger.isDebugEnabled()) {
                this.logger.debug("Invalid jsonp parameter value:" + strMo34r);
            }
            strMo34r = null;
        }
        JSONPObject jSONPObject = new JSONPObject(strMo34r);

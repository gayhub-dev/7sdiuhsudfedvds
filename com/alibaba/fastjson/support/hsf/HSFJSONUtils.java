...
public class HSFJSONUtils {
    ...
    public static Object[] parseInvocationArguments(String str, MethodLocator methodLocator) {
        ...
        if (i7 != 12) {
            ...
            while (i8 < strArrScanFieldStringArray.length) {
                Type type = genericParameterTypes[i8];
                String str2 = strArrScanFieldStringArray[i8];
                if (type != String.class) {
                    objArr2[i8] = TypeUtils.cast(str2, type, defaultJSONParser.getConfig());
                } else {
                    objArr2[i8] = str2;
                }
                i8++;
        ...
        if (methodFindMethod == null) {
            ...
            while (i8 < genericParameterTypes2.length) {

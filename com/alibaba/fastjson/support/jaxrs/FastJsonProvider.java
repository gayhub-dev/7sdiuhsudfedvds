...
public class FastJsonProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
    ...
    public Object readFrom(Class<Object> cls, Type type, Annotation[] annotationArr, MediaType mediaType, MultivaluedMap<String, String> multivaluedMap, InputStream inputStream) throws WebApplicationException {
        try {
            ...
            throw new WebApplicationException(sbM112a.toString(), e7);
        }
    }
    ...
    public FastJsonProvider setPretty(boolean z6) {
        this.pretty = z6;
        return this;
    }
    ...
    public void writeTo(Object obj, Class<?> cls, Type type, Annotation[] annotationArr, MediaType mediaType, MultivaluedMap<String, Object> multivaluedMap, OutputStream outputStream) throws WebApplicationException, IOException {
        ...
        try {
            ...
            StringBuilder sbM112a = C0413b.m112a("Could not write JSON: ");
            sbM112a.append(e7.getMessage());
            throw new WebApplicationException(sbM112a.toString(), e7);
        }
    }

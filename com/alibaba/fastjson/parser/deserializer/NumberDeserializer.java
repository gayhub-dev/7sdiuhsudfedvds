    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        ...
        if (jSONLexer.token() == 2) {
            ...
            if (type == Short.TYPE || type == Short.class) {
                if (jLongValue > 32767 || jLongValue < -32768) {
                    throw new JSONException(C0534b.m341a("short overflow : ", jLongValue));
                }
        ...
        if (type == Double.TYPE || type == Double.class) {
            try {
                ...
                throw new JSONException(C0532a.m338a("parseDouble error, field : ", obj), e7);
            }
        }
        if (type == Short.TYPE || type == Short.class) {
            try {
                ...
                throw new JSONException(C0532a.m338a("parseShort error, field : ", obj), e8);
            }
        }
        if (type != Byte.TYPE && type != Byte.class) {
        ...
        try {
            ...
            throw new JSONException(C0532a.m338a("parseByte error, field : ", obj), e9);
        }
    }

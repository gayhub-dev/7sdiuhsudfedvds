...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    private static String toString(Node node) throws TransformerException {
        try {
            ...
            throw new JSONException("xml node to string error", e7);
        }
    }
    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        ...
        if (type != InetSocketAddress.class) {
            ...
            if (!(type instanceof Class)) {
                StringBuilder sbM112a = C0413b.m112a("MiscCodec not support ");
            ...
            throw new JSONException(C0063n.m88a("MiscCodec not support ", name));
        }
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i7) throws TransformerException, IOException {
        String string;

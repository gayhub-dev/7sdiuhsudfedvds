...
public class CollectionCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i7) throws IOException {
        ...
        Type collectionItemType = (serializeWriter.isEnabled(serializerFeature) || SerializerFeature.isEnabled(i7, serializerFeature)) ? TypeUtils.getCollectionItemType(type) : null;
            ...
            for (Object obj3 : collection) {
                ...
                if (obj3 == null) {
                    ...
                    if (cls == Integer.class) {
                        ...
                        if (SerializerFeature.isEnabled(i7, SerializerFeature.WriteClassName) && (objectWriter instanceof JavaBeanSerializer)) {
                            ((JavaBeanSerializer) objectWriter).writeNoneASM(jSONSerializer, obj3, Integer.valueOf(i9 - 1), collectionItemType, i7);
                        } else {
                            objectWriter.write(jSONSerializer, obj3, Integer.valueOf(i9 - 1), collectionItemType, i7);
                        }
                    }
                }
                i8 = i9;

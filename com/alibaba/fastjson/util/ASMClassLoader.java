...
public class ASMClassLoader extends ClassLoader {
    ...
    public static class C05351 implements PrivilegedAction<Object> {
        @Override // java.security.PrivilegedAction
        public Object run() {
            return ASMClassLoader.class.getProtectionDomain();
        }
    ...
    public Class<?> defineClassPublic(String str, byte[] bArr, int i7, int i8) {
        return defineClass(str, bArr, i7, i8, DOMAIN);
    }

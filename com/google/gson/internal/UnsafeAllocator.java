...
public abstract class UnsafeAllocator {
    public static void assertInstantiable(Class<?> cls) {
        ...
        if (Modifier.isInterface(modifiers)) {
            throw new UnsupportedOperationException(C0319a.m107a(cls, C0413b.m112a("Interface can't be instantiated! Interface name: ")));
        }
        if (Modifier.isAbstract(modifiers)) {
            throw new UnsupportedOperationException(C0319a.m107a(cls, C0413b.m112a("Abstract class can't be instantiated! Class name: ")));
        }
    }

...
public final class TypeAdapters {
    ...
    public static /* synthetic */ class C084936 {
                ...
                for (T t6 : cls.getEnumConstants()) {
                    ...
                    if (serializedName != null) {
                        ...
                        for (String str : serializedName.alternate()) {
                            this.nameToConstant.put(str, t6);
                        }
                    }
                    this.nameToConstant.put(strName, t6);
                    this.constantToName.put(t6, strName);
                }
    ...
    static {
        TypeAdapter<Class> typeAdapterNullSafe = new TypeAdapter<Class>() { // from class: com.google.gson.internal.bind.TypeAdapters.1
            ...
            public void write(JsonWriter jsonWriter, Class cls) {
                StringBuilder sbM112a = C0413b.m112a("Attempted to serialize java.lang.Class: ");
                sbM112a.append(cls.getName());
                sbM112a.append(". Forgot to register a type adapter?");
            ...
            */
            public java.util.BitSet read(com.google.gson.stream.JsonReader r7) throws java.io.IOException {
                ...
                Ld:
                    ...
                    if (r1 == r3) goto L69
                    int[] r3 = com.google.gson.internal.bind.TypeAdapters.C084936.$SwitchMap$com$google$gson$stream$JsonToken
                    int r4 = r1.ordinal()
                    r3 = r3[r4]
                    r4 = 1
                    if (r3 == r4) goto L55
                ...
                L69:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C08312.read(com.google.gson.stream.JsonReader):java.util.BitSet");
            }
        ...
        TypeAdapter<Number> typeAdapter5 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                int i7 = C084936.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
                if (i7 == 1 || i7 == 3) {
        ...
        TypeAdapter<Character> typeAdapter6 = new TypeAdapter<Character>() { // from class: com.google.gson.internal.bind.TypeAdapters.15
            ...
            public Character read(JsonReader jsonReader) throws IOException {
                ...
                throw new JsonSyntaxException(C0063n.m88a("Expecting character, got: ", strNextString));
            }
        ...
        TypeAdapter<JsonElement> typeAdapter16 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.29
            ...
            public JsonElement read(JsonReader jsonReader) throws IOException {
                switch (C084936.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
            ...
            public void write(JsonWriter jsonWriter, JsonElement jsonElement) throws IOException {
                ...
                if (!jsonElement.isJsonObject()) {
                    StringBuilder sbM112a = C0413b.m112a("Couldn't write ");
                    sbM112a.append(jsonElement.getClass());
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.34
            ...
            public String toString() {
                StringBuilder sbM112a = C0413b.m112a("Factory[type=");
                sbM112a.append(cls.getName());
                sbM112a.append("+");
                sbM112a.append(cls2.getName());
                sbM112a.append(",adapter=");
                sbM112a.append(typeAdapter);
                sbM112a.append("]");
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> cls, final TypeAdapter<T1> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.35
                ...
                if (cls.isAssignableFrom(rawType)) {
                    return (TypeAdapter<T2>) new TypeAdapter<T1>() { // from class: com.google.gson.internal.bind.TypeAdapters.35.1
                        ...
                        public T1 read(JsonReader jsonReader) {
                            ...
                            StringBuilder sbM112a = C0413b.m112a("Expected a ");
                            sbM112a.append(rawType.getName());
                            sbM112a.append(" but was ");
                            sbM112a.append(t12.getClass().getName());
                            throw new JsonSyntaxException(sbM112a.toString());
                        }
            ...
            public String toString() {
                StringBuilder sbM112a = C0413b.m112a("Factory[typeHierarchy=");
                sbM112a.append(cls.getName());
                sbM112a.append(",adapter=");
                sbM112a.append(typeAdapter);
                sbM112a.append("]");

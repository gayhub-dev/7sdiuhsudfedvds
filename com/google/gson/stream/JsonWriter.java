...
public class JsonWriter implements Closeable, Flushable {
    ...
    private JsonWriter close(int i7, int i8, String str) throws IOException {
        int iPeek = peek();
        if (iPeek != i8 && iPeek != i7) {
            throw new IllegalStateException("Nesting problem.");
        }
        if (this.deferredName != null) {
            StringBuilder sbM112a = C0413b.m112a("Dangling name: ");
            sbM112a.append(this.deferredName);
    ...
    private JsonWriter open(int i7, String str) throws IOException {
        beforeValue();
        push(i7);
        this.out.write(str);
        return this;

...
public class ConnectionManagerService {
    ...
    public synchronized ConnectionInfo getCurrentConnectionInfo(@UpnpInputArgument(name = "ConnectionID") int i7) {
        ConnectionInfo connectionInfo;
        log.fine("Getting connection information of connection ID: " + i7);
        connectionInfo = this.activeConnections.get(Integer.valueOf(i7));
        if (connectionInfo == null) {
            throw new ConnectionManagerException(ConnectionManagerErrorCode.INVALID_CONNECTION_REFERENCE, "Non-active connection ID: " + i7);
        }

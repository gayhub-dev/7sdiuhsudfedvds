...
public abstract class GetCurrentConnectionInfo extends ActionCallback {
    public GetCurrentConnectionInfo(Service service, int i7) {
    ...
    public void success(ActionInvocation actionInvocation) {
        try {
            ...
            actionInvocation.setFailure(new ActionException(ErrorCode.ACTION_FAILED, "Can't parse ConnectionInfo response: " + e7, e7));
            failure(actionInvocation, null);
        }
    }

    public GetCurrentConnectionInfo(Service service, ControlPoint controlPoint, int i7) {

...
public class TextItem extends Item {
    ...
    public Person[] getContributors() {
        List propertyValues = getPropertyValues(DIDLObject.Property.C1707DC.CONTRIBUTOR.class);
    ...
    public Person getFirstContributor() {
        return (Person) getFirstPropertyValue(DIDLObject.Property.C1707DC.CONTRIBUTOR.class);
    }

    public Person getFirstPublisher() {
        return (Person) getFirstPropertyValue(DIDLObject.Property.C1707DC.PUBLISHER.class);
    }

    public URI getFirstRelation() {
        return (URI) getFirstPropertyValue(DIDLObject.Property.C1707DC.RELATION.class);
    }

    public String getFirstRights() {
        return (String) getFirstPropertyValue(DIDLObject.Property.C1707DC.RIGHTS.class);
    }
    ...
    public Person[] getPublishers() {
        List propertyValues = getPropertyValues(DIDLObject.Property.C1707DC.PUBLISHER.class);
        return (Person[]) propertyValues.toArray(new Person[propertyValues.size()]);
    }
    ...
    public URI[] getRelations() {
        List propertyValues = getPropertyValues(DIDLObject.Property.C1707DC.RELATION.class);
        return (URI[]) propertyValues.toArray(new URI[propertyValues.size()]);
    }

    public String[] getRights() {
        List propertyValues = getPropertyValues(DIDLObject.Property.C1707DC.RIGHTS.class);
    ...
    public TextItem setContributors(Person[] personArr) {
        removeProperties(DIDLObject.Property.C1707DC.CONTRIBUTOR.class);
        for (Person person : personArr) {
            addProperty(new DIDLObject.Property.C1707DC.CONTRIBUTOR(person));
        }
        return this;
    }
    ...
    public TextItem setPublishers(Person[] personArr) {
        removeProperties(DIDLObject.Property.C1707DC.PUBLISHER.class);
        for (Person person : personArr) {
            addProperty(new DIDLObject.Property.C1707DC.PUBLISHER(person));
        }
        return this;
    }
    ...
    public TextItem setRelations(URI[] uriArr) {
        removeProperties(DIDLObject.Property.C1707DC.RELATION.class);
        for (URI uri : uriArr) {
            addProperty(new DIDLObject.Property.C1707DC.RELATION(uri));
        }
        return this;
    }

    public TextItem setRights(String[] strArr) {
        removeProperties(DIDLObject.Property.C1707DC.RIGHTS.class);
        for (String str : strArr) {
            addProperty(new DIDLObject.Property.C1707DC.RIGHTS(str));
        }
        return this;
    }

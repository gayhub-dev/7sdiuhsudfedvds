...
public class DLNAHeaders extends UpnpHeaders {
    ...
    @Override // org.fourthline.cling.model.message.UpnpHeaders, p082j6.C1212a
    ...
    @Override // org.fourthline.cling.model.message.UpnpHeaders, p082j6.C1212a, java.util.Map
    public void clear() {
        this.parsedDLNAHeaders = null;
        super.clear();
    }

    public boolean containsKey(DLNAHeader.Type type) throws IllegalAccessException, InstantiationException {
    ...
    public List<UpnpHeader> get(DLNAHeader.Type type) throws IllegalAccessException, InstantiationException {
        if (this.parsedDLNAHeaders == null) {
            parseHeaders();
        }
    ...
    public UpnpHeader[] getAsArray(DLNAHeader.Type type) throws IllegalAccessException, InstantiationException {
        if (this.parsedDLNAHeaders == null) {
            parseHeaders();
        }
    ...
    @Override // org.fourthline.cling.model.message.UpnpHeaders
    public void parseHeaders() throws IllegalAccessException, InstantiationException {
    ...
    public <H extends UpnpHeader> H getFirstHeader(DLNAHeader.Type type, Class<H> cls) throws IllegalAccessException, InstantiationException {

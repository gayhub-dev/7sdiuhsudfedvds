...
public abstract class Browse extends ActionCallback {
    ...
    public void success(ActionInvocation actionInvocation) {
        ...
        try {
            ...
            actionInvocation.setFailure(new ActionException(ErrorCode.ACTION_FAILED, "Can't parse DIDL XML response: " + e7, e7));
    ...
    public Browse(Service service, String str, BrowseFlag browseFlag, String str2, long j7, Long l7, SortCriterion... sortCriterionArr) {
        ...
        getActionInvocation().setInput("StartingIndex", new UnsignedIntegerFourBytes(j7));
        getActionInvocation().setInput("RequestedCount", new UnsignedIntegerFourBytes(l7 == null ? getDefaultMaxResults() : l7.longValue()));

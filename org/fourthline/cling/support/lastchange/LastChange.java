...
public class LastChange {
    ...
    public synchronized <EV extends EventedValue> EV getEventedValue(int i7, Class<EV> cls) {
        return (EV) getEventedValue(new UnsignedIntegerFourBytes(i7), cls);
    }
    ...
    public synchronized void setEventedValue(int i7, EventedValue... eventedValueArr) {
        setEventedValue(new UnsignedIntegerFourBytes(i7), eventedValueArr);
    }

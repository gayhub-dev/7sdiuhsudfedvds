...
public class UpnpServiceImpl implements UpnpService {
    ...
    public void shutdownRouter() {
        try {
            ...
            if (thM2475O instanceof InterruptedException) {
                log.log(Level.INFO, "Router shutdown was interrupted: " + e7, thM2475O);
                return;
            }
            log.log(Level.SEVERE, "Router error on shutdown: " + e7, thM2475O);
        }
    }
    ...
    public UpnpServiceImpl(UpnpServiceConfiguration upnpServiceConfiguration, RegistryListener... registryListenerArr) {
        ...
        Log.m655i("XLog_DLNA ", ">>> Starting UPnP service...");
        Logger logger = log;
        StringBuilder sbM112a = C0413b.m112a("Using configuration: ");
        sbM112a.append(getConfiguration().getClass().getName());
    ...
    public void shutdown(boolean z6) {
        Runnable runnable = new Runnable() { // from class: org.fourthline.cling.UpnpServiceImpl.1
            ...
            public void run() {
                ...
                Log.m655i("XLog_DLNA ", ">>> Shutting down UPnP service...");
                ...
                Log.m655i("XLog_DLNA ", "<<< UPnP service shutdown completed");
            }
        };
        if (z6) {

...
public class ReceivingSearch extends ReceivingAsync<IncomingSearchRequest> {
    ...
    public void execute() {
        ...
        if (!getInputMessage().isMANSSDPDiscover()) {
            Logger logger = log;
            StringBuilder sbM112a = C0413b.m112a("Invalid search request, no or invalid MAN ssdp:discover header: ");
        ...
        if (searchTarget == null) {
            Logger logger2 = log;
            StringBuilder sbM112a2 = C0413b.m112a("Invalid search request, did not contain ST header: ");
    ...
    public void sendResponses(UpnpHeader upnpHeader, NetworkAddress networkAddress) {
        ...
        Logger logger = log;
        StringBuilder sbM112a = C0413b.m112a("Non-implemented search request target: ");
    ...
    public boolean waitBeforeExecution() throws InterruptedException {
        ...
        if (mx == null) {
            Logger logger = log;
            StringBuilder sbM112a = C0413b.m112a("Invalid search request, did not contain MX header: ");
            sbM112a.append(getInputMessage());
            logger.fine(sbM112a.toString());
            return false;
        }

...
public class SoapActionType {
    ...
    public static SoapActionType valueOf(String str) {
        ...
        try {
            ...
            throw new InvalidValueException(C0063n.m88a("Can't parse action type string (namespace/type/version#actionName): ", str));
        } catch (RuntimeException e7) {
            throw new InvalidValueException(String.format("Can't parse action type string (namespace/type/version#actionName) '%s': %s", str, e7.toString()));
        }
    }
    ...
    public String getTypeString() {
        if (this.version == null) {
            ...
            sbM112a.append(":");
            sbM112a.append(getType());
            return sbM112a.toString();
        }
        StringBuilder sbM112a2 = C0413b.m112a("urn:");
        sbM112a2.append(getNamespace());
        sbM112a2.append(":service:");
        sbM112a2.append(getType());
        sbM112a2.append(":");
        sbM112a2.append(getVersion());
    ...
    public SoapActionType(String str, String str2, Integer num, String str3) {
        ...
        if (str3 != null && !ModelUtil.isValidUDAName(str3)) {
            throw new IllegalArgumentException(C0063n.m88a("Action name contains illegal characters: ", str3));
        }
    }
}

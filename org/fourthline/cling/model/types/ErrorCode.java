...
public enum ErrorCode {
    ...
    ARGUMENT_VALUE_INVALID(IjkMediaCodecInfo.RANK_LAST_CHANCE, "The argument value is invalid"),
    ...
    public static ErrorCode getByCode(int i7) {
        for (ErrorCode errorCode : values()) {
            if (errorCode.getCode() == i7) {
                return errorCode;
            }
        }
        return null;

...
public class DeviceDetails implements Validatable {
    ...
    public List<ValidationError> validate() throws NumberFormatException {
        ...
        if (getUpc() != null) {
            if (getUpc().length() != 12) {
                Logger logger = log;
                StringBuilder sbM112a = C0413b.m112a("UPnP specification violation, UPC must be 12 digits: ");
                sbM112a.append(getUpc());
                ...
                try {
                    ...
                    Logger logger2 = log;
                    StringBuilder sbM112a2 = C0413b.m112a("UPnP specification violation, UPC must be 12 digits all-numeric: ");
                    sbM112a2.append(getUpc());

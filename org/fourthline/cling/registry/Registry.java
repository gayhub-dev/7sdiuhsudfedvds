...
public interface Registry {
    ...
    void addResource(Resource resource, int i7);

    void advertiseLocalDevices();

    UpnpServiceConfiguration getConfiguration();

    Device getDevice(UDN udn, boolean z6);
    ...
    LocalDevice getLocalDevice(UDN udn, boolean z6);
    ...
    RemoteDevice getRemoteDevice(UDN udn, boolean z6);

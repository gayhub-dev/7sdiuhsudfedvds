...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_SHOW_ON_SCREEN = new AccessibilityActionCompat(i7 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SHOW_ON_SCREEN : null);
            ACTION_SCROLL_TO_POSITION = new AccessibilityActionCompat(i7 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_TO_POSITION : null);
            ACTION_SCROLL_UP = new AccessibilityActionCompat(i7 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_UP : null);
            ACTION_SCROLL_LEFT = new AccessibilityActionCompat(i7 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_LEFT : null);
            ACTION_SCROLL_DOWN = new AccessibilityActionCompat(i7 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_DOWN : null);
            ACTION_SCROLL_RIGHT = new AccessibilityActionCompat(i7 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_RIGHT : null);
            ACTION_CONTEXT_CLICK = new AccessibilityActionCompat(i7 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_CONTEXT_CLICK : null);
            ACTION_SET_PROGRESS = new AccessibilityActionCompat(i7 >= 24 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SET_PROGRESS : null);
            ACTION_MOVE_WINDOW = new AccessibilityActionCompat(i7 >= 26 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_MOVE_WINDOW : null);
            ACTION_SHOW_TOOLTIP = new AccessibilityActionCompat(i7 >= 28 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SHOW_TOOLTIP : null);
            ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(i7 >= 28 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_HIDE_TOOLTIP : null);
        }
    ...
    public static class CollectionInfoCompat {
        ...
        public static CollectionInfoCompat obtain(int i7, int i8, boolean z6, int i9) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i7, i8, z6, i9));
        }
        ...
        public static CollectionInfoCompat obtain(int i7, int i8, boolean z6) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i7, i8, z6));
        }
    }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static CollectionItemInfoCompat obtain(int i7, int i8, int i9, int i10, boolean z6, boolean z7) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i7, i8, i9, i10, z6, z7));
        }
        ...
        public static CollectionItemInfoCompat obtain(int i7, int i8, int i9, int i10, boolean z6) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i7, i8, i9, i10, z6));
        }
    }
    ...
    public static class RangeInfoCompat {
        ...
        public static RangeInfoCompat obtain(int i7, float f7, float f8, float f9) {
    ...
    private static String getActionSymbolicName(int i7) {
        if (i7 == 1) {
            return "ACTION_FOCUS";
        }
        if (i7 == 2) {
    ...
    private boolean getBooleanProperty(int i7) {
        Bundle extras = getExtras();
        return extras != null && (extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & i7) == i7;
    }
    ...
    private void setBooleanProperty(int i7, boolean z6) {
        Bundle extras = getExtras();
        if (extras != null) {
            int i8 = extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & (~i7);
            if (!z6) {
                i7 = 0;
            }
            extras.putInt(BOOLEAN_PROPERTY_KEY, i7 | i8);
        }
    }
    ...
    public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByText(String str) {
        ...
        for (int i7 = 0; i7 < size; i7++) {
            arrayList.add(wrap(listFindAccessibilityNodeInfosByText.get(i7)));
        }
        return arrayList;
    }
    ...
    public AccessibilityNodeInfoCompat findFocus(int i7) {
        return wrapNonNullInstance(this.mInfo.findFocus(i7));
    }

    public AccessibilityNodeInfoCompat focusSearch(int i7) {
        return wrapNonNullInstance(this.mInfo.focusSearch(i7));
    }
    ...
    public AccessibilityNodeInfoCompat getChild(int i7) {
        return wrapNonNullInstance(this.mInfo.getChild(i7));
    }
    ...
    public boolean performAction(int i7) {
        return this.mInfo.performAction(i7);
    }
    ...
    public void setDrawingOrder(int i7) {
        if (Build.VERSION.SDK_INT >= 24) {
            this.mInfo.setDrawingOrder(i7);
        }
    }
    ...
    public void setMaxTextLength(int i7) {
        this.mInfo.setMaxTextLength(i7);
    }

    public void setMovementGranularities(int i7) {
        this.mInfo.setMovementGranularities(i7);
    }
    ...
    public void setTextSelection(int i7, int i8) {
        this.mInfo.setTextSelection(i7, i8);
    }
    ...
    public static AccessibilityNodeInfoCompat obtain(View view, int i7) {
        return wrapNonNullInstance(AccessibilityNodeInfo.obtain(view, i7));
    }
    ...
    public void addChild(View view, int i7) {
        this.mInfo.addChild(view, i7);
    }

    public boolean performAction(int i7, Bundle bundle) {
        return this.mInfo.performAction(i7, bundle);
    }

    public boolean removeChild(View view, int i7) {
        return this.mInfo.removeChild(view, i7);
    }

    public void setLabelFor(View view, int i7) {
        this.mInfo.setLabelFor(view, i7);
    }

    public void setLabeledBy(View view, int i7) {
        this.mInfo.setLabeledBy(view, i7);
    }

    public void setParent(View view, int i7) {
        this.mParentVirtualDescendantId = i7;
        this.mInfo.setParent(view, i7);
    }

    public void setSource(View view, int i7) {
        this.mInfo.setSource(view, i7);
    }

    public void setTraversalAfter(View view, int i7) {
        if (Build.VERSION.SDK_INT >= 22) {
            this.mInfo.setTraversalAfter(view, i7);
        }
    }

    public void setTraversalBefore(View view, int i7) {
        if (Build.VERSION.SDK_INT >= 22) {
            this.mInfo.setTraversalBefore(view, i7);
        }
    }

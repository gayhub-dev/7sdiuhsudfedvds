...
public final class GestureDetectorCompat {
    ...
    public static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        private boolean isConsideredDoubleTap(MotionEvent motionEvent, MotionEvent motionEvent2, MotionEvent motionEvent3) {
            ...
            return (y6 * y6) + (x6 * x6) < this.mDoubleTapSlopSquare;
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            for (int i8 = 0; i8 < pointerCount; i8++) {
                if (actionIndex != i8) {
                    x6 += motionEvent.getX(i8);
                    y6 += motionEvent.getY(i8);
                }
            }
            float f7 = z6 ? pointerCount - 1 : pointerCount;
            float f8 = x6 / f7;
            float f9 = y6 / f7;
            if (i7 == 0) {
            ...
            if (i7 == 1) {
                ...
                float f10 = this.mLastFocusX - f8;
                float f11 = this.mLastFocusY - f9;
                if (this.mIsDoubleTapping) {
                ...
                int i10 = (int) (f8 - this.mDownFocusX);
                int i11 = (int) (f9 - this.mDownFocusY);

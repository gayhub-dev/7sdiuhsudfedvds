...
public final class MotionEventCompat {
    ...
    @Deprecated
    public static float getAxisValue(MotionEvent motionEvent, int i7) {
    ...
    @Deprecated
    public static float getX(MotionEvent motionEvent, int i7) {
        return motionEvent.getX(i7);
    }

    @Deprecated
    public static float getY(MotionEvent motionEvent, int i7) {
        return motionEvent.getY(i7);
    }

    public static boolean isFromSource(MotionEvent motionEvent, int i7) {
        return (motionEvent.getSource() & i7) == i7;
    }

    @Deprecated
    public static float getAxisValue(MotionEvent motionEvent, int i7, int i8) {

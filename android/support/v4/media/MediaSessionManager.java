...
public final class MediaSessionManager {
    ...
    public static final class RemoteUserInfo {
        ...
        public RemoteUserInfo(@NonNull String str, int i7, int i8) {
            if (Build.VERSION.SDK_INT >= 28) {
                this.mImpl = new MediaSessionManagerImplApi28.RemoteUserInfoImplApi28(str, i7, i8);
            } else {
                this.mImpl = new MediaSessionManagerImplBase.RemoteUserInfoImplBase(str, i7, i8);
            }
        }

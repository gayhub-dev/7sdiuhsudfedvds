...
class MediaBrowserServiceCompatApi21 {
    ...
    public static class MediaBrowserServiceAdaptor extends MediaBrowserService {
        ...
        public MediaBrowserService.BrowserRoot onGetRoot(String str, int i7, Bundle bundle) {
            ...
            BrowserRoot browserRootOnGetRoot = this.mServiceProxy.onGetRoot(str, i7, bundle == null ? null : new Bundle(bundle));
    ...
    public static class ResultWrapper<T> {
        ...
        public void sendResult(T t6) {
            if (t6 instanceof List) {
                this.mResultObj.sendResult(parcelListToItemList((List) t6));
                return;
            }
    ...
    public interface ServiceCompatProxy {
        BrowserRoot onGetRoot(String str, int i7, Bundle bundle);

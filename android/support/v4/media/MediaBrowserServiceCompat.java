...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int i7, Bundle bundle) {
            Bundle extras;
            ...
            mediaBrowserServiceCompat.mCurConnection = mediaBrowserServiceCompat.new ConnectionRecord(str, -1, i7, bundle, null);
            BrowserRoot browserRootOnGetRoot = MediaBrowserServiceCompat.this.onGetRoot(str, i7, bundle);
        ...
        public void notifyChildrenChangedForCompat(final MediaSessionManager.RemoteUserInfo remoteUserInfo, final String str, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.4
                @Override // java.lang.Runnable
                public void run() {
                    for (int i7 = 0; i7 < MediaBrowserServiceCompat.this.mConnections.size(); i7++) {
                        ConnectionRecord connectionRecordValueAt = MediaBrowserServiceCompat.this.mConnections.valueAt(i7);
    ...
    public static class Result<T> {
        ...
        public void detach() {
            if (this.mDetachCalled) {
                StringBuilder sbM112a = C0413b.m112a("detach() called when detach() had already been called for: ");
                sbM112a.append(this.mDebug);
                throw new IllegalStateException(sbM112a.toString());
            }
            if (this.mSendResultCalled) {
                StringBuilder sbM112a2 = C0413b.m112a("detach() called when sendResult() had already been called for: ");
                sbM112a2.append(this.mDebug);
                throw new IllegalStateException(sbM112a2.toString());
            }
            if (!this.mSendErrorCalled) {
                this.mDetachCalled = true;
            } else {
                StringBuilder sbM112a3 = C0413b.m112a("detach() called when sendError() had already been called for: ");
                sbM112a3.append(this.mDebug);
        ...
        public void onErrorSent(Bundle bundle) {
            StringBuilder sbM112a = C0413b.m112a("It is not supported to send an error for ");
            sbM112a.append(this.mDebug);
            throw new UnsupportedOperationException(sbM112a.toString());
        }

        public void onProgressUpdateSent(Bundle bundle) {
            StringBuilder sbM112a = C0413b.m112a("It is not supported to send an interim update for ");
            sbM112a.append(this.mDebug);
            throw new UnsupportedOperationException(sbM112a.toString());
        }
        ...
        public void sendError(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder sbM112a = C0413b.m112a("sendError() called when either sendResult() or sendError() had already been called for: ");
                sbM112a.append(this.mDebug);
                throw new IllegalStateException(sbM112a.toString());
            }
        ...
        public void sendProgressUpdate(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder sbM112a = C0413b.m112a("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
                sbM112a.append(this.mDebug);
                throw new IllegalStateException(sbM112a.toString());
            }
        ...
        public void sendResult(T t6) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder sbM112a = C0413b.m112a("sendResult() called when either sendResult() or sendError() had already been called for: ");
                sbM112a.append(this.mDebug);
                throw new IllegalStateException(sbM112a.toString());
            }
    ...
    public class ServiceBinderImpl {
        ...
        public void connect(final String str, final int i7, final int i8, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i8)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() throws RemoteException {
                        ...
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.new ConnectionRecord(str, i7, i8, bundle, serviceCallbacks);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat.mCurConnection = connectionRecord;
                        BrowserRoot browserRootOnGetRoot = mediaBrowserServiceCompat.onGetRoot(str, i8, bundle);
        ...
        public void registerCallbacks(final ServiceCallbacks serviceCallbacks, final String str, final int i7, final int i8, final Bundle bundle) {
        ...
        public void sendCustomAction(final String str, final Bundle bundle, final ResultReceiver resultReceiver, final ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.9
                ...
                public void run() {
                    ...
                    StringBuilder sbM112a = C0413b.m112a("sendCustomAction for callback that isn't registered action=");
                    sbM112a.append(str);
                    sbM112a.append(", extras=");
                    sbM112a.append(bundle);
                }
            });
        }
    ...
    public static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        private void sendRequest(int i7, Bundle bundle) throws RemoteException {
    ...
    public void performLoadChildren(final String str, final ConnectionRecord connectionRecord, final Bundle bundle, final Bundle bundle2) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(C0164a.m99a(C0413b.m112a("onLoadChildren must call detach() or sendResult() before returning for package="), connectionRecord.pkg, " id=", str));
        }
    }
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(C0063n.m88a("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(C0063n.m88a("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }

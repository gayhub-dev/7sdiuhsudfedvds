...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public static class StubApi21 implements MediaControllerCompatApi21.Callback {
            ...
            public void onAudioInfoChanged(int i7, int i8, int i9, int i10, int i11) {
                ...
                if (callback != null) {
                    callback.onAudioInfoChanged(new PlaybackInfo(i7, i8, i9, i10, i11));
                }
            }
    ...
    public MediaControllerCompat(Context context, @NonNull MediaSessionCompat mediaSessionCompat) {
        ...
        MediaControllerImpl mediaControllerImplApi24 = null;
        try {
            int i7 = Build.VERSION.SDK_INT;
            mediaControllerImplApi24 = i7 >= 24 ? new MediaControllerImplApi24(context, sessionToken) : i7 >= 23 ? new MediaControllerImplApi23(context, sessionToken) : new MediaControllerImplApi21(context, sessionToken);
        } catch (RemoteException unused) {
        }
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        ...
        if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException(C0096a.m97a("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
            }
        }
    }
    ...
    public static class TransportControlsApi21 extends TransportControls {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void seekTo(long j7) {
            MediaControllerCompatApi21.TransportControls.seekTo(this.mControlsObj, j7);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void skipToQueueItem(long j7) {
            MediaControllerCompatApi21.TransportControls.skipToQueueItem(this.mControlsObj, j7);
        }
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void adjustVolume(int i7, int i8) {
            MediaControllerCompatApi21.adjustVolume(this.mControllerObj, i7, i8);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void setVolumeTo(int i7, int i8) {
            MediaControllerCompatApi21.setVolumeTo(this.mControllerObj, i7, i8);
        }

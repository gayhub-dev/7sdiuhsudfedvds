...
class MediaControllerCompatApi21 {
    ...
    public interface Callback {
        void onAudioInfoChanged(int i7, int i8, int i9, int i10, int i11);
    ...
    public static class TransportControls {
        ...
        public static void seekTo(Object obj, long j7) {
            ((MediaController.TransportControls) obj).seekTo(j7);
        }
        ...
        public static void skipToQueueItem(Object obj, long j7) {
            ((MediaController.TransportControls) obj).skipToQueueItem(j7);
        }
    ...
    public static void adjustVolume(Object obj, int i7, int i8) {
        ((MediaController) obj).adjustVolume(i7, i8);
    }
    ...
    public static void setVolumeTo(Object obj, int i7, int i8) {
        ((MediaController) obj).setVolumeTo(i7, i8);
    }

...
public class MediaButtonReceiver extends BroadcastReceiver {
    ...
    private static ComponentName getServiceComponentByAction(Context context, String str) {
        ...
        StringBuilder sbM95a = C0081c.m95a("Expected 1 service that handles ", str, ", found ");
        sbM95a.append(listQueryIntentServices.size());
        throw new IllegalStateException(sbM95a.toString());
    }
    ...
    public static PendingIntent buildMediaButtonPendingIntent(Context context, ComponentName componentName, long j7) {
        int keyCode;
        if (componentName == null || (keyCode = PlaybackStateCompat.toKeyCode(j7)) == 0) {
            return null;
        }
        Intent intent = new Intent("android.intent.action.MEDIA_BUTTON");

...
public class AudioAttributesCompat implements InterfaceC0498c {
    public static final String AUDIO_ATTRIBUTES_CONTENT_TYPE = "android.support.v4.media.audio_attrs.CONTENT_TYPE";
    public static final String AUDIO_ATTRIBUTES_FLAGS = "android.support.v4.media.audio_attrs.FLAGS";
    public static final String AUDIO_ATTRIBUTES_FRAMEWORKS = "android.support.v4.media.audio_attrs.FRAMEWORKS";
    public static final String AUDIO_ATTRIBUTES_LEGACY_STREAM_TYPE = "android.support.v4.media.audio_attrs.LEGACY_STREAM_TYPE";
    public static final String AUDIO_ATTRIBUTES_USAGE = "android.support.v4.media.audio_attrs.USAGE";
    ...
    public static int usageForStreamType(int i7) {
        switch (i7) {
        }
        return 2;
    }

    public static String usageToString(int i7) {
        switch (i7) {
            case 0:
            ...
            case 15:
            default:
                return C0079a.m93a("unknown usage ", i7);
            case 16:
    ...
    public static int toVolumeStreamType(boolean z6, int i7, int i8) {
        if ((i7 & 1) == 1) {
            return z6 ? 1 : 7;
        }
        if ((i7 & 4) == 4) {
    ...
    public static class Builder {
        ...
        public Builder setFlags(int i7) {
            this.mFlags = (i7 & AudioAttributesCompat.FLAG_ALL) | this.mFlags;
            return this;
        }

        /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
        public Builder setInternalLegacyStreamType(int i7) {
            switch (i7) {
                case 0:
                    this.mContentType = 1;
                    break;
            ...
            this.mUsage = AudioAttributesCompat.usageForStreamType(i7);
            return this;
        }

        public Builder setLegacyStreamType(int i7) {
            if (i7 == 10) {
                throw new IllegalArgumentException("STREAM_ACCESSIBILITY is not a legacy stream type that was used for audio playback");
            }
            this.mLegacyStream = i7;
            return setInternalLegacyStreamType(i7);
        }

...
public abstract class JobIntentService extends Service {
    ...
    public final class CompatWorkItem implements GenericWorkItem {
        ...
        public CompatWorkItem(Intent intent, int i7) {
            this.mIntent = intent;
            this.mStartId = i7;
        }
    ...
    public static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        public JobWorkEnqueuer(Context context, ComponentName componentName, int i7) {
            super(context, componentName);
            ensureJobId(i7);
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i7) {
            if (!this.mHasJobId) {
                ...
                StringBuilder sbM98a = C0116a.m98a("Given job ID ", i7, " is different than previous ");
                sbM98a.append(this.mJobId);
    ...
    public static void enqueueWork(@NonNull Context context, @NonNull Class cls, int i7, @NonNull Intent intent) {
        enqueueWork(context, new ComponentName(context, (Class<?>) cls), i7, intent);
    }

    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z6, int i7) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            compatWorkEnqueuer = new JobWorkEnqueuer(context, componentName, i7);
        }
    ...
    public int onStartCommand(@Nullable Intent intent, int i7, int i8) {
        ...
        synchronized (this.mCompatQueue) {
            ...
            arrayList.add(new CompatWorkItem(intent, i8));
    ...
    public static void enqueueWork(@NonNull Context context, @NonNull ComponentName componentName, int i7, @NonNull Intent intent) {
        ...
        synchronized (sLock) {
            WorkEnqueuer workEnqueuer = getWorkEnqueuer(context, componentName, true, i7);
            workEnqueuer.ensureJobId(i7);

...
public abstract class FragmentManager {
    ...
    @Nullable
    public abstract Fragment findFragmentById(@IdRes int i7);
    ...
    public abstract void popBackStack(int i7, int i8);

    public abstract void popBackStack(@Nullable String str, int i7);

    public abstract boolean popBackStackImmediate();

    public abstract boolean popBackStackImmediate(int i7, int i8);

    public abstract boolean popBackStackImmediate(@Nullable String str, int i7);

    public abstract void putFragment(@NonNull Bundle bundle, @NonNull String str, @NonNull Fragment fragment);

    public abstract void registerFragmentLifecycleCallbacks(@NonNull FragmentLifecycleCallbacks fragmentLifecycleCallbacks, boolean z6);

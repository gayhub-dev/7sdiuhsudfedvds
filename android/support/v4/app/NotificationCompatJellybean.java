...
class NotificationCompatJellybean {
    ...
    private static RemoteInput[] fromBundleArray(Bundle[] bundleArr) {
        ...
        for (int i7 = 0; i7 < bundleArr.length; i7++) {
            remoteInputArr[i7] = fromBundle(bundleArr[i7]);
        }
            ...
            try {
                try {
                    ...
                    if (actionObjectsLocked != null) {
                        Object obj = actionObjectsLocked[i7];
                        Bundle extras = getExtras(notification);
                        return readAction(sActionIconField.getInt(obj), (CharSequence) sActionTitleField.get(obj), (PendingIntent) sActionIntentField.get(obj), (extras == null || (sparseParcelableArray = extras.getSparseParcelableArray(NotificationCompatExtras.EXTRA_ACTION_EXTRAS)) == null) ? null : (Bundle) sparseParcelableArray.get(i7));
                    }
    ...
    public static NotificationCompat.Action readAction(int i7, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        return new NotificationCompat.Action(i7, charSequence, pendingIntent, bundle, remoteInputArrFromBundleArray, remoteInputArrFromBundleArray2, z6, 0, true);
    }
    ...
    private static Bundle[] toBundleArray(RemoteInput[] remoteInputArr) {
        ...
        for (int i7 = 0; i7 < remoteInputArr.length; i7++) {
            bundleArr[i7] = toBundle(remoteInputArr[i7]);
        }
        return bundleArr;
    }

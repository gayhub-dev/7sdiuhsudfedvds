...
public class FrameMetricsAggregator {
    ...
    public static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        public Window.OnFrameMetricsAvailableListener mListener = new Window.OnFrameMetricsAvailableListener() { // from class: android.support.v4.app.FrameMetricsAggregator.FrameMetricsApi24Impl.1
        ...
        public FrameMetricsApi24Impl(int i7) {
            this.mTrackingFlags = i7;
        }
        ...
        public void add(Activity activity) {
            ...
            for (int i7 = 0; i7 <= 8; i7++) {
                ...
                if (sparseIntArrayArr[i7] == null && (this.mTrackingFlags & (1 << i7)) != 0) {
        ...
        public void addDurationItem(SparseIntArray sparseIntArray, long j7) {
    ...
    public FrameMetricsAggregator(int i7) {
        if (Build.VERSION.SDK_INT >= 24) {
            this.mInstance = new FrameMetricsApi24Impl(i7);
        } else {

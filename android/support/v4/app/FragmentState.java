...
final class FragmentState implements Parcelable {
    ...
    public Fragment instantiate(FragmentHostCallback fragmentHostCallback, FragmentContainer fragmentContainer, Fragment fragment, FragmentManagerNonConfig fragmentManagerNonConfig, C0065p c0065p) {
        if (this.mInstance == null) {
            ...
            if (FragmentManagerImpl.DEBUG) {
                C0413b.m112a("Instantiated fragment ").append(this.mInstance);
            }
        }
        Fragment fragment3 = this.mInstance;
        fragment3.mChildNonConfig = fragmentManagerNonConfig;
        fragment3.mViewModelStore = c0065p;
        return fragment3;
    }

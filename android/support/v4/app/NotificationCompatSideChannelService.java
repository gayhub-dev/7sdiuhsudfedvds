...
public abstract class NotificationCompatSideChannelService extends Service {
    ...
    public class NotificationSideChannelStub extends INotificationSideChannel.Stub {
        ...
        public void cancel(String str, int i7, String str2) {
            ...
            try {
                NotificationCompatSideChannelService.this.cancel(str, i7, str2);
            } finally {
        ...
        public void notify(String str, int i7, String str2, Notification notification) {
            ...
            long jClearCallingIdentity = Binder.clearCallingIdentity();
            try {
                NotificationCompatSideChannelService.this.notify(str, i7, str2, notification);
            } finally {
                Binder.restoreCallingIdentity(jClearCallingIdentity);
            }
        }
    ...
    public abstract void cancel(String str, int i7, String str2);

    public abstract void cancelAll(String str);

    public void checkPermission(int i7, String str) {
    ...
    public abstract void notify(String str, int i7, String str2, Notification notification);

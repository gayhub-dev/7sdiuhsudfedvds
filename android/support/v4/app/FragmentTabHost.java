...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder sbM112a = C0413b.m112a("FragmentTabHost.SavedState{");
            sbM112a.append(Integer.toHexString(System.identityHashCode(this)));
            sbM112a.append(" curTab=");
            return C0072a.m92a(sbM112a, this.curTab, "}");
        }
    ...
    private void ensureContent() {
        if (this.mRealTabContent == null) {
            ...
            StringBuilder sbM112a = C0413b.m112a("No tab content FrameLayout found for id ");
            sbM112a.append(this.mContainerId);
    ...
    public void setup(Context context, FragmentManager fragmentManager, int i7) {
        ensureHierarchy(context);
        super.setup();
        this.mContext = context;
        this.mFragmentManager = fragmentManager;

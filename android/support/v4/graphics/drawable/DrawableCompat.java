...
public final class DrawableCompat {
    ...
    public static void setAutoMirrored(@NonNull Drawable drawable, boolean z6) {
        drawable.setAutoMirrored(z6);
    }

    public static void setHotspot(@NonNull Drawable drawable, float f7, float f8) {
        drawable.setHotspot(f7, f8);
    }

    public static void setHotspotBounds(@NonNull Drawable drawable, int i7, int i8, int i9, int i10) {
        drawable.setHotspotBounds(i7, i8, i9, i10);
    }

    public static boolean setLayoutDirection(@NonNull Drawable drawable, int i7) {
        if (Build.VERSION.SDK_INT >= 23) {
    ...
    public static void setTint(@NonNull Drawable drawable, @ColorInt int i7) {
        drawable.setTint(i7);
    }

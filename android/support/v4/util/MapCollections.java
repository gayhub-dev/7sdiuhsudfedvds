...
abstract class MapCollections<K, V> {
    ...
    public final class ArrayIterator<T> implements Iterator<T> {
        ...
        public void remove() {
            ...
            MapCollections.this.colRemoveAt(i7);
        }
    }
    ...
    public final class ValuesCollection implements Collection<V> {
        ...
        public boolean removeAll(Collection<?> collection) {
            ...
            int i7 = 0;
            boolean z6 = false;
            while (i7 < iColGetSize) {
                if (collection.contains(MapCollections.this.colGetEntry(i7, 1))) {
                    MapCollections.this.colRemoveAt(i7);
                    i7--;
                    iColGetSize--;
                    z6 = true;
    ...
    public abstract Object colGetEntry(int i7, int i8);
    ...
    public abstract void colPut(K k7, V v6);

    public abstract void colRemoveAt(int i7);

    public abstract V colSetValue(int i7, V v6);

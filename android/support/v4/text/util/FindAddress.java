...
class FindAddress {
    ...
    /* renamed from: NL */
    private static final String f153NL = "\n\u000b\f\r\u0085\u2028\u2029";

    /* renamed from: SP */
    private static final String f154SP = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000";
    private static final String WORD_DELIM = ",*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
    private static final String WORD_END = "(?=[,*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029]|$)";

    /* renamed from: WS */
    private static final String f155WS = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
    ...
    public static class ZipRange {
        ...
        public ZipRange(int i7, int i8, int i9, int i10) {
            this.mLow = i7;
            this.mHigh = i8;
            this.mException1 = i9;
            this.mException2 = i9;
        ...
        public boolean matches(String str) throws NumberFormatException {
            int i7 = Integer.parseInt(str.substring(0, 2));
            return (this.mLow <= i7 && i7 <= this.mHigh) || i7 == this.mException1 || i7 == this.mException2;
        }
    }
    ...
    */
    ...
    private static boolean checkHouseNumber(String str) throws NumberFormatException {
        ...
        int i10 = i9 % 10;
        if (i10 == 1) {
            return lowerCase.equals(i9 % 100 != 11 ? "st" : "th");
        }
        if (i10 == 2) {
            return lowerCase.equals(i9 % 100 != 12 ? "nd" : "th");
        }
        if (i10 != 3) {
            return lowerCase.equals("th");
        }
        return lowerCase.equals(i9 % 100 != 13 ? "rd" : "th");
    }
    ...
    public static MatchResult matchHouseNumber(String str, int i7) {
        ...
        Matcher matcherRegion = sHouseNumberRe.matcher(str).region(i7, str.length());
    ...
    public static MatchResult matchState(String str, int i7) {
        ...
        Matcher matcherRegion = sStateRe.matcher(str).region(i7, str.length());
        if (matcherRegion.lookingAt()) {

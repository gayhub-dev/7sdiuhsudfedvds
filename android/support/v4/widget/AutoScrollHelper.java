...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public static class ClampedScroller {
        ...
        private float getValueAt(long j7) {
            if (j7 < this.mStartTime) {
                return 0.0f;
            }
            long j8 = this.mStopTime;
            if (j8 < 0 || j7 < j8) {
                return AutoScrollHelper.constrain((j7 - r0) / this.mRampUpDuration, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY) * 0.5f;
            }
            float f7 = this.mStopValue;
            return (AutoScrollHelper.constrain((j7 - j8) / this.mEffectiveRampDown, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY) * f7) + (AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY - f7);
        }

        private float interpolateValue(float f7) {
            return (f7 * 4.0f) + ((-4.0f) * f7 * f7);
        }
        ...
        public void computeScrollDelta() {
            ...
            long j7 = jCurrentAnimationTimeMillis - this.mDeltaTime;
            this.mDeltaTime = jCurrentAnimationTimeMillis;
            float f7 = j7 * fInterpolateValue;
        ...
        public int getHorizontalDirection() {
            float f7 = this.mTargetVelocityX;
            return (int) (f7 / Math.abs(f7));
        }

        public int getVerticalDirection() {
            float f7 = this.mTargetVelocityY;
            return (int) (f7 / Math.abs(f7));
        }
    ...
    private float computeTargetVelocity(int i7, float f7, float f8, float f9) {
        float edgeValue = getEdgeValue(this.mRelativeEdges[i7], f8, this.mMaximumEdges[i7], f7);
        if (edgeValue == 0.0f) {
            return 0.0f;
        }
        float f10 = this.mRelativeVelocity[i7];
        float f11 = this.mMinimumVelocity[i7];
        float f12 = this.mMaximumVelocity[i7];
        float f13 = f10 * f9;
    ...
    private float constrainEdgeValue(float f7, float f8) {
        if (f8 == 0.0f) {
            return 0.0f;
        }
        int i7 = this.mEdgeType;
        if (i7 == 0 || i7 == 1) {
            if (f7 < f8) {
                if (f7 >= 0.0f) {
                    return DEFAULT_RELATIVE_VELOCITY - (f7 / f8);
                }
                if (this.mAnimating && i7 == 1) {
    ...
    private float getEdgeValue(float f7, float f8, float f9, float f10) {
        float interpolation;
        float fConstrain = constrain(f7 * f8, 0.0f, f9);
    ...
    private void startAnimating() {
        ...
        if (this.mAlreadyDelayed || (i7 = this.mActivationDelay) <= 0) {
            this.mRunnable.run();
        } else {
            ViewCompat.postOnAnimationDelayed(this.mTarget, this.mRunnable, i7);
        }
    ...
    */
    ...
    @NonNull
    public AutoScrollHelper setActivationDelay(int i7) {
        this.mActivationDelay = i7;
        return this;
    }

    @NonNull
    public AutoScrollHelper setEdgeType(int i7) {
        this.mEdgeType = i7;
        return this;
    }
    ...
    @NonNull
    public AutoScrollHelper setMaximumEdges(float f7, float f8) {
    ...
    @NonNull
    public AutoScrollHelper setMaximumVelocity(float f7, float f8) {
    ...
    @NonNull
    public AutoScrollHelper setMinimumVelocity(float f7, float f8) {
    ...
    @NonNull
    public AutoScrollHelper setRampDownDuration(int i7) {
        this.mScroller.setRampDownDuration(i7);
        return this;
    }

    @NonNull
    public AutoScrollHelper setRampUpDuration(int i7) {
        this.mScroller.setRampUpDuration(i7);
        return this;
    }

    @NonNull
    public AutoScrollHelper setRelativeEdges(float f7, float f8) {
    ...
    @NonNull
    public AutoScrollHelper setRelativeVelocity(float f7, float f8) {

...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
    ...
    public interface OnScrollChangeListener {
        void onScrollChange(NestedScrollView nestedScrollView, int i7, int i8, int i9, int i10);
    }
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder sbM112a = C0413b.m112a("HorizontalScrollView.SavedState{");
            sbM112a.append(Integer.toHexString(System.identityHashCode(this)));
            sbM112a.append(" scrollPosition=");
            return C0084a.m96a(sbM112a, this.scrollPosition, "}");
        }
    ...
    */
    ...
    private void flingWithNestedDispatch(int i7) {
        int scrollY = getScrollY();
        boolean z6 = (scrollY > 0 || i7 > 0) && (scrollY < getScrollRange() || i7 < 0);
        float f7 = i7;
    ...
    private boolean isWithinDeltaOfScreen(View view, int i7, int i8) {
        view.getDrawingRect(this.mTempRect);
        offsetDescendantRectToMyCoords(view, this.mTempRect);
        return this.mTempRect.bottom + i7 >= getScrollY() && this.mTempRect.top - i7 <= getScrollY() + i8;
    }
    ...
    private boolean scrollAndFocus(int i7, int i8, int i9) {
        ...
        if (i8 < scrollY || i9 > i10) {
            doScrollY(z7 ? i8 - scrollY : i9 - i10);
            z6 = true;
        }
        if (viewFindFocusableViewInBounds != findFocus()) {
            viewFindFocusableViewInBounds.requestFocus(i7);
        }
        return z6;
    }
    ...
    public void computeScroll() {
        ...
        int i7 = currY - this.mLastScrollerY;
        if (dispatchNestedPreScroll(0, i7, this.mScrollConsumed, null, 1)) {
        ...
        if (i8 != 0) {
            ...
            if (!dispatchNestedScroll(0, scrollY2, 0, i8 - scrollY2, null, 1)) {
    ...
    public boolean dispatchNestedFling(float f7, float f8, boolean z6) {
        return this.mChildHelper.dispatchNestedFling(f7, f8, z6);
    }

    @Override // android.view.View, android.support.v4.view.NestedScrollingChild
    public boolean dispatchNestedPreFling(float f7, float f8) {
        return this.mChildHelper.dispatchNestedPreFling(f7, f8);
    }
    ...
    public void fling(int i7) {
        if (getChildCount() > 0) {
            ...
            this.mScroller.fling(getScrollX(), getScrollY(), 0, i7, 0, 0, Integer.MIN_VALUE, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, 0, 0);
    ...
    public boolean fullScroll(int i7) {
        ...
        return scrollAndFocus(i7, rect3.top, rect3.bottom);
    }
    ...
    public void measureChild(View view, int i7, int i8) {
        ...
        view.measure(FrameLayout.getChildMeasureSpec(i7, getPaddingRight() + getPaddingLeft(), layoutParams.width), View.MeasureSpec.makeMeasureSpec(0, 0));
    }

    @Override // android.view.ViewGroup
    public void measureChildWithMargins(View view, int i7, int i8, int i9, int i10) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
        view.measure(FrameLayout.getChildMeasureSpec(i7, getPaddingRight() + getPaddingLeft() + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin + i8, marginLayoutParams.width), View.MeasureSpec.makeMeasureSpec(marginLayoutParams.topMargin + marginLayoutParams.bottomMargin, 0));
    }
    ...
    */
    ...
    public void onMeasure(int i7, int i8) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i8) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(FrameLayout.getChildMeasureSpec(i7, getPaddingRight() + getPaddingLeft() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, 1073741824));
            }
        }
    }
    ...
    public boolean onNestedFling(View view, float f7, float f8, boolean z6) {
        ...
        flingWithNestedDispatch((int) f8);
        return true;
    }
    ...
    public void onNestedScroll(View view, int i7, int i8, int i9, int i10, int i11) {
        ...
        scrollBy(0, i10);
        int scrollY2 = getScrollY() - scrollY;
        dispatchNestedScroll(0, scrollY2, 0, i10 - scrollY2, null, i11);
    }
    ...
    public void onScrollChanged(int i7, int i8, int i9, int i10) {
        ...
        if (onScrollChangeListener != null) {
            onScrollChangeListener.onScrollChange(this, i7, i8, i9, i10);
        }
    }
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (iFindPointerIndex != -1) {
                    ...
                    int i7 = this.mLastMotionY - y6;
                    if (dispatchNestedPreScroll(0, i7, this.mScrollConsumed, this.mScrollOffset, 0)) {
                        i7 -= this.mScrollConsumed[1];
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        int scrollY2 = getScrollY() - scrollY;
                        if (dispatchNestedScroll(0, scrollY2, 0, i8 - scrollY2, this.mScrollOffset, 0)) {
            ...
            boolean z7 = !this.mScroller.isFinished();
    ...
    */
    ...
    public boolean pageScroll(int i7) {
        ...
        int i9 = height + i8;
        rect3.bottom = i9;
        return scrollAndFocus(i7, i8, i9);
    }
    ...
    public void scrollTo(int i7, int i8) {
        if (getChildCount() > 0) {
            ...
            int iClamp = clamp(i7, width, width2);
    ...
    public final void smoothScrollBy(int i7, int i8) {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - this.mLastScroll > 250) {
            ...
            int scrollY = getScrollY();
            int iMax = Math.max(0, Math.min(i8 + scrollY, Math.max(0, height - height2))) - scrollY;
            this.mLastScrollerY = getScrollY();
    ...
    public final void smoothScrollTo(int i7, int i8) {
        smoothScrollBy(i7 - getScrollX(), i8 - getScrollY());
    }
    ...
    public NestedScrollView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i7) {
        ...
        initScrollView();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, SCROLLVIEW_STYLEABLE, i7, 0);

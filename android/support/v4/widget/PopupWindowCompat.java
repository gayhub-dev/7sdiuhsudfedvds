...
public final class PopupWindowCompat {
    ...
    public static void setOverlapAnchor(@NonNull PopupWindow popupWindow, boolean z6) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 23) {
    ...
    public static void setWindowLayoutType(@NonNull PopupWindow popupWindow, int i7) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 23) {

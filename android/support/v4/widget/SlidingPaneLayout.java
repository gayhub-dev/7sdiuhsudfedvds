...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public int clampViewPositionHorizontal(View view, int i7, int i8) {
            ...
            if (!SlidingPaneLayout.this.isLayoutRtlSupport()) {
                ...
                return Math.min(Math.max(i7, paddingLeft), SlidingPaneLayout.this.mSlideRange + paddingLeft);
            }
            ...
            return Math.max(Math.min(i7, width), width - SlidingPaneLayout.this.mSlideRange);
        }
        ...
        public void onEdgeDragStarted(int i7, int i8) {
            ...
            slidingPaneLayout.mDragHelper.captureChildView(slidingPaneLayout.mSlideableView, i8);
        }
        ...
        public void onViewPositionChanged(View view, int i7, int i8, int i9, int i10) {
            SlidingPaneLayout.this.onPanelDragged(i7);
        ...
        public void onViewReleased(View view, float f7, float f8) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                ...
                if (f7 < 0.0f || (f7 == 0.0f && SlidingPaneLayout.this.mSlideOffset > 0.5f)) {
    ...
    public interface PanelSlideListener {
        ...
        void onPanelSlide(@NonNull View view, float f7);
    }
    ...
    private boolean closePane(View view, int i7) {
        if (!this.mFirstLayout && !smoothSlideTo(0.0f, i7)) {
            return false;
        }
    ...
    private void dimChildView(View view, float f7, int i7) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        if (f7 > 0.0f && i7 != 0) {
            int i8 = (((int) ((((-16777216) & i7) >>> 24) * f7)) << 24) | (i7 & ViewCompat.MEASURED_SIZE_MASK);
            if (layoutParams.dimPaint == null) {
                layoutParams.dimPaint = new Paint();
            }
            layoutParams.dimPaint.setColorFilter(new PorterDuffColorFilter(i8, PorterDuff.Mode.SRC_OVER));
    ...
    private boolean openPane(View view, int i7) {
        if (!this.mFirstLayout && !smoothSlideTo(1.0f, i7)) {
            return false;
        }
    ...
    */
    ...
    public boolean canScroll(View view, boolean z6, int i7, int i8, int i9) {
        ...
        if (z6) {
            if (view.canScrollHorizontally(isLayoutRtlSupport() ? i7 : -i7)) {
                return true;
            }
        }
        return false;
    ...
    public void onDetachedFromWindow() {
        ...
        for (int i7 = 0; i7 < size; i7++) {
            this.mPostedRunnables.get(i7).run();
        }
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    int iMin = (Math.min(paddingRight, i19 - this.mOverhangSize) - i17) - (((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
                    this.mSlideRange = iMin;
                    int i20 = zIsLayoutRtlSupport ? ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin : ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin;
                    layoutParams.dimWhenOffset = (measuredWidth / 2) + ((i17 + i20) + iMin) > i19;
                    int i21 = (int) (iMin * this.mSlideOffset);
                    i11 = i20 + i21 + i17;
                    this.mSlideOffset = i21 / iMin;
                    i12 = 0;
    ...
    */
    ...
    public void onPanelDragged(int i7) {
        ...
        float paddingRight = (i7 - ((zIsLayoutRtlSupport ? getPaddingRight() : getPaddingLeft()) + (zIsLayoutRtlSupport ? ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin : ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin))) / this.mSlideRange;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            float x7 = motionEvent.getX();
            float y7 = motionEvent.getY();
            float f7 = x7 - this.mInitialMotionX;
            float f8 = y7 - this.mInitialMotionY;
            int touchSlop = this.mDragHelper.getTouchSlop();
            if ((f8 * f8) + (f7 * f7) < touchSlop * touchSlop && this.mDragHelper.isViewUnder(this.mSlideableView, (int) x7, (int) y7)) {
    ...
    public boolean smoothSlideTo(float f7, int i7) {
        int paddingLeft;
        if (!this.mCanSlide) {
            return false;
        }
        ...
        if (zIsLayoutRtlSupport) {
            ...
            paddingLeft = (int) (getWidth() - (((f7 * this.mSlideRange) + paddingRight) + this.mSlideableView.getWidth()));
        } else {
            paddingLeft = (int) ((f7 * this.mSlideRange) + getPaddingLeft() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin);
        }
    ...
    public SlidingPaneLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i7) {
        ...
        this.mOverhangSize = (int) ((32.0f * f7) + 0.5f);
        ...
        viewDragHelperCreate.setMinVelocity(f7 * 400.0f);
    }

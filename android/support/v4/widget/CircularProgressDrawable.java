...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public static class Ring {
        ...
        public void draw(Canvas canvas, Rect rect) {
            ...
            float f7 = this.mRingCenterRadius;
            float fMin = (this.mStrokeWidth / 2.0f) + f7;
            if (f7 <= 0.0f) {
        ...
        public void drawTriangle(Canvas canvas, float f7, float f8, RectF rectF) {
            if (this.mShowArrow) {
        ...
        public void setColorIndex(int i7) {
            this.mColorIndex = i7;
            this.mCurrentColor = this.mColors[i7];
        }
        ...
        public void setEndTrim(float f7) {
            this.mEndTrim = f7;
        }
        ...
        public void setStartTrim(float f7) {
            this.mStartTrim = f7;
        }
    ...
    private void applyFinishTranslation(float f7, Ring ring) {
        updateRingColor(f7, ring);
        float fFloor = (float) (Math.floor(ring.getStartingRotation() / MAX_PROGRESS_ARC) + 1.0d);
        ring.setStartTrim((((ring.getStartingEndTrim() - MIN_PROGRESS_ARC) - ring.getStartingStartTrim()) * f7) + ring.getStartingStartTrim());
        ring.setEndTrim(ring.getStartingEndTrim());
        ring.setRotation(((fFloor - ring.getStartingRotation()) * f7) + ring.getStartingRotation());
    }

    private int evaluateColorChange(float f7, int i7, int i8) {
    ...
    public void applyTransformation(float f7, Ring ring, boolean z6) {
        float interpolation;
        float interpolation2;
        if (this.mFinishing) {
            applyFinishTranslation(f7, ring);
            return;
        }
        if (f7 != 1.0f || z6) {
            ...
            if (f7 < 0.5f) {
                ...
                interpolation2 = (MATERIAL_INTERPOLATOR.getInterpolation(f7 / 0.5f) * 0.79f) + MIN_PROGRESS_ARC + interpolation;
            } else {
                float startingStartTrim = ring.getStartingStartTrim() + 0.79f;
                interpolation = startingStartTrim - (((1.0f - MATERIAL_INTERPOLATOR.getInterpolation((f7 - 0.5f) / 0.5f)) * 0.79f) + MIN_PROGRESS_ARC);
                interpolation2 = startingStartTrim;
            }
            float f8 = (RING_ROTATION * f7) + startingRotation;
            float f9 = (f7 + this.mRotationCount) * GROUP_FULL_ROTATION;
    ...
    @Override // android.graphics.drawable.Drawable
    public void setAlpha(int i7) {
        this.mRing.setAlpha(i7);
        invalidateSelf();
    }

    public void setArrowDimensions(float f7, float f8) {
        this.mRing.setArrowDimensions(f7, f8);
        invalidateSelf();
    }
    ...
    public void setArrowScale(float f7) {
        this.mRing.setArrowScale(f7);
        invalidateSelf();
    }

    public void setBackgroundColor(int i7) {
        this.mRing.setBackgroundColor(i7);
        invalidateSelf();
    }

    public void setCenterRadius(float f7) {
        this.mRing.setCenterRadius(f7);
        invalidateSelf();
    }
    ...
    public void setProgressRotation(float f7) {
        this.mRing.setRotation(f7);
        invalidateSelf();
    }

    public void setStartEndTrim(float f7, float f8) {
        this.mRing.setStartTrim(f7);
    ...
    public void updateRingColor(float f7, Ring ring) {
        if (f7 > 0.75f) {
            ring.setColor(evaluateColorChange((f7 - 0.75f) / 0.25f, ring.getStartingColor(), ring.getNextColor()));
        } else {

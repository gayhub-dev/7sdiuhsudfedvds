...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) throws IOException {
            try {
                ...
                if (entry == null) {
                    throw new IllegalArgumentException(C0063n.m88a("Failed to find configured root that contains ", canonicalPath));
                }
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(C0063n.m88a("Invalid mode: ", str));
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        for (String str3 : strArr) {
            if ("_display_name".equals(str3)) {
                ...
                i7 = i8 + 1;
                objArr[i8] = fileForUri.getName();
            } else if ("_size".equals(str3)) {
                strArr3[i8] = "_size";
                i7 = i8 + 1;
                objArr[i8] = Long.valueOf(fileForUri.length());
            }
            i8 = i7;
        }

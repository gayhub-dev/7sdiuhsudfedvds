...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    public static /* synthetic */ class C01704 {
    ...
    static {
        ThreadFactory threadFactory = new ThreadFactory() { // from class: android.support.v4.content.ModernAsyncTask.1
            ...
            public Thread newThread(Runnable runnable) {
                StringBuilder sbM112a = C0413b.m112a("ModernAsyncTask #");
                sbM112a.append(this.mCount.getAndIncrement());
                return new Thread(runnable, sbM112a.toString());
            }
        };
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        ...
        int i7 = C01704.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
        if (i7 == 1) {
    ...
    public final Result get(long j7, TimeUnit timeUnit) {
        return this.mFuture.get(j7, timeUnit);
    }
}

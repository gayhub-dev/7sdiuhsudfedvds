...
public class ContextCompat {
    ...
    @ColorInt
    public static int getColor(@NonNull Context context, @ColorRes int i7) {
        return Build.VERSION.SDK_INT >= 23 ? context.getColor(i7) : context.getResources().getColor(i7);
    }

    @Nullable
    public static ColorStateList getColorStateList(@NonNull Context context, @ColorRes int i7) {

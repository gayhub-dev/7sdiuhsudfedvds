        ...
        while (true) {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                ...
                for (int i8 = 0; i8 < size2; i8++) {
                    ReceiverRecord receiverRecord = broadcastRecord.receivers.get(i8);
            ...
            if (arrayList3 != null) {
                ...
                if (arrayList5 != null) {
                    for (int i9 = 0; i9 < arrayList5.size(); i9++) {
                        ((ReceiverRecord) arrayList5.get(i9)).broadcasting = false;
                    }
    ...
    public void unregisterReceiver(@NonNull BroadcastReceiver broadcastReceiver) {
        synchronized (this.mReceivers) {
            ...
            for (int size = arrayListRemove.size() - 1; size >= 0; size--) {
                ...
                for (int i7 = 0; i7 < receiverRecord.filter.countActions(); i7++) {
                    String action = receiverRecord.filter.getAction(i7);

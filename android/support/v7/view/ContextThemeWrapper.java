...
public class ContextThemeWrapper extends ContextWrapper {
    ...
    public Resources.Theme getTheme() {
        ...
        if (this.mThemeResource == 0) {
            this.mThemeResource = C0308R.style.Theme_AppCompat_Light;
        }
        initializeTheme();
        return this.mTheme;
    }
    ...
    public void setTheme(int i7) {
        if (this.mThemeResource != i7) {
            this.mThemeResource = i7;
            initializeTheme();
        }
    }

    public ContextThemeWrapper(Context context, @StyleRes int i7) {
        super(context);
        this.mThemeResource = i7;
    }

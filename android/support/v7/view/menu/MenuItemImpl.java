...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    private static void appendModifier(StringBuilder sb, int i7, int i8, String str) {
        if ((i7 & i8) == i8) {
            sb.append(str);
        }
    }
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(C0308R.string.abc_prepend_shortcut_label));
        }
        int i7 = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, i7, 65536, resources.getString(C0308R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, i7, 4096, resources.getString(C0308R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, i7, 2, resources.getString(C0308R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, i7, 1, resources.getString(C0308R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, i7, 4, resources.getString(C0308R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, i7, 8, resources.getString(C0308R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
            sb.append(resources.getString(C0308R.string.abc_menu_delete_shortcut_label));
        } else if (shortcut == '\n') {
            sb.append(resources.getString(C0308R.string.abc_menu_enter_shortcut_label));
        } else if (shortcut != ' ') {
            sb.append(shortcut);
        } else {
            sb.append(resources.getString(C0308R.string.abc_menu_space_shortcut_label));
        }
        return sb.toString();
    }
    ...
    public SupportMenuItem setActionView(View view) {
        ...
        if (view != null && view.getId() == -1 && (i7 = this.mId) > 0) {
            view.setId(i7);
        }
        this.mMenu.onItemActionRequestChanged(this);
        return this;
    ...
    public MenuItem setAlphabeticShortcut(char c7, int i7) {
        if (this.mShortcutAlphabeticChar == c7 && this.mShortcutAlphabeticModifiers == i7) {
            return this;
        }
        this.mShortcutAlphabeticChar = Character.toLowerCase(c7);
    ...
    public MenuItem setNumericShortcut(char c7, int i7) {
        if (this.mShortcutNumericChar == c7 && this.mShortcutNumericModifiers == i7) {
            return this;
        }
        this.mShortcutNumericChar = c7;
    ...
    public MenuItem setTitle(int i7) {
        return setTitle(this.mMenu.getContext().getString(i7));
    }

...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    public MenuItem setAlphabeticShortcut(char c7) {
        ((SupportMenuItem) this.mWrappedObject).setAlphabeticShortcut(c7);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setCheckable(boolean z6) {
        ((SupportMenuItem) this.mWrappedObject).setCheckable(z6);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setChecked(boolean z6) {
        ((SupportMenuItem) this.mWrappedObject).setChecked(z6);
        return this;
    }
    ...
    public MenuItem setEnabled(boolean z6) {
        ((SupportMenuItem) this.mWrappedObject).setEnabled(z6);
        return this;
    }

    public void setExclusiveCheckable(boolean z6) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        try {
    ...
    public MenuItem setNumericShortcut(char c7) {
        ((SupportMenuItem) this.mWrappedObject).setNumericShortcut(c7);
        return this;
    }
    ...
    public MenuItem setShortcut(char c7, char c8) {
        ((SupportMenuItem) this.mWrappedObject).setShortcut(c7, c8);
        return this;
    }

    @Override // android.view.MenuItem
    public void setShowAsAction(int i7) {
        ((SupportMenuItem) this.mWrappedObject).setShowAsAction(i7);
    }

    @Override // android.view.MenuItem
    public MenuItem setShowAsActionFlags(int i7) {
        ((SupportMenuItem) this.mWrappedObject).setShowAsActionFlags(i7);
        return this;
    }
    ...
    public MenuItem setVisible(boolean z6) {
        return ((SupportMenuItem) this.mWrappedObject).setVisible(z6);
    }

    @Override // android.view.MenuItem
    public MenuItem setAlphabeticShortcut(char c7, int i7) {
        ((SupportMenuItem) this.mWrappedObject).setAlphabeticShortcut(c7, i7);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setIcon(int i7) {
        ((SupportMenuItem) this.mWrappedObject).setIcon(i7);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setNumericShortcut(char c7, int i7) {
        ((SupportMenuItem) this.mWrappedObject).setNumericShortcut(c7, i7);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setShortcut(char c7, char c8, int i7, int i8) {
        ((SupportMenuItem) this.mWrappedObject).setShortcut(c7, c8, i7, i8);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setTitle(int i7) {
        ((SupportMenuItem) this.mWrappedObject).setTitle(i7);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setActionView(int i7) {
        ((SupportMenuItem) this.mWrappedObject).setActionView(i7);
        View actionView = ((SupportMenuItem) this.mWrappedObject).getActionView();

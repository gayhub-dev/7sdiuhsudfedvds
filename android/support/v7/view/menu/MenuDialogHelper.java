...
class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void onClick(DialogInterface dialogInterface, int i7) {
        this.mMenu.performItemAction((MenuItemImpl) this.mPresenter.getAdapter().getItem(i7), 0);
    }
    ...
    public boolean onKey(DialogInterface dialogInterface, int i7, KeyEvent keyEvent) {
        ...
        return this.mMenu.performShortcut(i7, keyEvent, 0);
    }
    ...
    public void show(IBinder iBinder) {
        ...
        ListMenuPresenter listMenuPresenter = new ListMenuPresenter(builder.getContext(), C0308R.layout.abc_list_menu_item_layout);

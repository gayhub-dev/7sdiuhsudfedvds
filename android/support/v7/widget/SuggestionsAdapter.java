...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0308R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0308R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String str) throws NumberFormatException, IOException {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + ServiceReference.DELIMITER + i7;
            Drawable drawableCheckIconCache = checkIconCache(str2);
            if (drawableCheckIconCache != null) {
                return drawableCheckIconCache;
            }
            Drawable drawable = ContextCompat.getDrawable(this.mProviderContext, i7);
    ...
    private Drawable getIcon1(Cursor cursor) throws NumberFormatException, IOException {
        int i7 = this.mIconName1Col;
        if (i7 == -1) {
            return null;
        }
        Drawable drawableFromResourceValue = getDrawableFromResourceValue(cursor.getString(i7));
        return drawableFromResourceValue != null ? drawableFromResourceValue : getDefaultIcon1(cursor);
    }

    private Drawable getIcon2(Cursor cursor) {
        int i7 = this.mIconName2Col;
        if (i7 == -1) {
            return null;
        }
        return getDrawableFromResourceValue(cursor.getString(i7));
    }

    private static String getStringOrNull(Cursor cursor, int i7) {
        if (i7 == -1) {
            return null;
        }
        try {
    ...
    private void setViewDrawable(ImageView imageView, Drawable drawable, int i7) {
    ...
    public View getDropDownView(int i7, View view, ViewGroup viewGroup) {
        try {
            ...
            if (viewNewDropDownView != null) {
                ((ChildViewCache) viewNewDropDownView.getTag()).mText1.setText(e7.toString());
            }
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i7) {
    ...
    public View getView(int i7, View view, ViewGroup viewGroup) {
        try {
            ...
            if (viewNewView != null) {
                ((ChildViewCache) viewNewView.getTag()).mText1.setText(e7.toString());
            }
            return viewNewView;
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) viewNewView.findViewById(C0308R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return viewNewView;
    }
    ...
    public void setQueryRefinement(int i7) {
        this.mQueryRefinement = i7;
    }
}

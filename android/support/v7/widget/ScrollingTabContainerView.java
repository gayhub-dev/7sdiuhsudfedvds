...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public Object getItem(int i7) {
            return ((TabView) ScrollingTabContainerView.this.mTabLayout.getChildAt(i7)).getTab();
        }
        ...
        public View getView(int i7, View view, ViewGroup viewGroup) {
            if (view == null) {
                return ScrollingTabContainerView.this.createTabView((ActionBar.Tab) getItem(i7), true);
            }
            ((TabView) view).bindTab((ActionBar.Tab) getItem(i7));
            return view;
        }
    }
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z6) {
            int i7 = C0308R.attr.actionBarTabStyle;
        ...
        public void update() {
            ...
            if (z6) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0308R.attr.actionBarTabTextStyle);
            ...
            TooltipCompat.setTooltipText(this, z6 ? null : tab.getContentDescription());
        }
    }
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0308R.attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0308R.attr.actionBarTabBarStyle);
    ...
    public void animateToTab(int i7) {
        final View childAt = this.mTabLayout.getChildAt(i7);
        Runnable runnable = this.mTabSelector;
        if (runnable != null) {
            removeCallbacks(runnable);
        }
    ...
    public void updateTab(int i7) {
        ((TabView) this.mTabLayout.getChildAt(i7)).update();
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
    ...
    public void addTab(ActionBar.Tab tab, int i7, boolean z6) {
        TabView tabViewCreateTabView = createTabView(tab, false);
        this.mTabLayout.addView(tabViewCreateTabView, i7, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }

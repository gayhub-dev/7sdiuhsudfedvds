...
class ViewInfoStore {
    ...
    private RecyclerView.ItemAnimator.ItemHolderInfo popFromLayoutStep(RecyclerView.ViewHolder viewHolder, int i7) {
        ...
        if (iIndexOfKey >= 0 && (infoRecordValueAt = this.mLayoutHolderMap.valueAt(iIndexOfKey)) != null) {
            int i8 = infoRecordValueAt.flags;
            if ((i8 & i7) != 0) {
                int i9 = (~i7) & i8;
                infoRecordValueAt.flags = i9;
                if (i7 == 4) {
    ...
    public void addToOldChangeHolders(long j7, RecyclerView.ViewHolder viewHolder) {
        this.mOldChangedHolders.put(j7, viewHolder);
    }
    ...
    public RecyclerView.ViewHolder getFromOldChangeHolders(long j7) {
        return this.mOldChangedHolders.get(j7);
    }
    ...
    public void process(ProcessCallback processCallback) {
        for (int size = this.mLayoutHolderMap.size() - 1; size >= 0; size--) {
            ...
            int i7 = infoRecordRemoveAt.flags;
            if ((i7 & 3) == 3) {

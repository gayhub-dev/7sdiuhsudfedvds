...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        public MoveInfo(RecyclerView.ViewHolder viewHolder, int i7, int i8, int i9, int i10) {
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i7, int i8, int i9, int i10) {
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, i7, i8, i9, i10));
        return true;
    }
    ...
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int i7, int i8, int i9, int i10) {
        ...
        this.mPendingMoves.add(new MoveInfo(viewHolder, translationX, translationY, i9, i10));
        return true;
    }

    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i7, int i8, int i9, int i10) {
        final View view = viewHolder.itemView;
        final int i11 = i9 - i7;
    ...
    public void runPendingAnimations() {
        ...
        if (z6 || z7 || z9 || z8) {
            ...
            if (z9) {
                ...
                if (z6 || z7 || z8) {
                    ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, Math.max(z7 ? getMoveDuration() : 0L, z8 ? getChangeDuration() : 0L) + (z6 ? getRemoveDuration() : 0L));
                } else {
                    runnable3.run();
                }
            }
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            StringBuilder sbM112a = C0413b.m112a("ChangeInfo{oldHolder=");
            sbM112a.append(this.oldHolder);
            sbM112a.append(", newHolder=");
            sbM112a.append(this.newHolder);
            sbM112a.append(", fromX=");
            sbM112a.append(this.fromX);
            sbM112a.append(", fromY=");
            sbM112a.append(this.fromY);
            sbM112a.append(", toX=");
            sbM112a.append(this.toX);
            sbM112a.append(", toY=");
            sbM112a.append(this.toY);
            sbM112a.append('}');
            return sbM112a.toString();
        }

        public ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i7, int i8, int i9, int i10) {

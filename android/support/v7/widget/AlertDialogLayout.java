    ...
    private boolean tryOnMeasure(int i7, int i8) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0308R.id.topPanel) {
                    view = childAt;
                } else if (id == C0308R.id.buttonPanel) {
                    view2 = childAt;
                } else {
                    if ((id != C0308R.id.contentPanel && id != C0308R.id.customPanel) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            int i11 = paddingBottom - iResolveMinimumHeight;

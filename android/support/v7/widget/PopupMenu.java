...
public class PopupMenu {
    ...
    public void inflate(@MenuRes int i7) {
        getMenuInflater().inflate(i7, this.mMenu);
    }

    public void setGravity(int i7) {
        this.mPopup.setGravity(i7);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View view, int i7) {
        this(context, view, i7, C0308R.attr.popupMenuStyle, 0);
    }

    public PopupMenu(@NonNull Context context, @NonNull View view, int i7, @AttrRes int i8, @StyleRes int i9) {

...
class AppCompatProgressBarHelper {
    ...
    private Drawable tileify(Drawable drawable, boolean z6) {
        if (drawable instanceof WrappedDrawable) {
            ...
            if (drawable instanceof LayerDrawable) {
                ...
                for (int i7 = 0; i7 < numberOfLayers; i7++) {
                    ...
                    drawableArr[i7] = tileify(layerDrawable.getDrawable(i7), id == 16908301 || id == 16908303);
                }
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        ...
        for (int i7 = 0; i7 < numberOfFrames; i7++) {
            Drawable drawableTileify = tileify(animationDrawable.getFrame(i7), true);
            drawableTileify.setLevel(10000);
            animationDrawable2.addFrame(drawableTileify, animationDrawable.getDuration(i7));
        }
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i7) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, TINT_ATTRS, i7, 0);

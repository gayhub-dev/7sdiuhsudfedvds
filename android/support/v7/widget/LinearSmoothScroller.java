...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    private int clampApplyScroll(int i7, int i8) {
        int i9 = i7 - i8;
        if (i7 * i9 <= 0) {
            return 0;
        }
    ...
    public int calculateTimeForScrolling(int i7) {
        return (int) Math.ceil(Math.abs(i7) * this.MILLISECONDS_PER_PX);
    }
    ...
    public void onSeekTargetStep(int i7, int i8, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
        this.mInterimTargetDx = clampApplyScroll(this.mInterimTargetDx, i7);

...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                checkedItemAdapter = this.mCursor == null ? new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, R.id.text1, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
                ...
                } : new CursorAdapter(this.mContext, this.mCursor, false) { // from class: android.support.v7.app.AlertController.AlertParams.2
                ...
                int i7 = this.mIsSingleChoice ? alertController.mSingleChoiceItemLayout : alertController.mListItemLayout;
                if (this.mCursor != null) {
                    checkedItemAdapter = new SimpleCursorAdapter(this.mContext, i7, this.mCursor, new String[]{this.mLabelColumn}, new int[]{R.id.text1});
                } else {
                    checkedItemAdapter = this.mAdapter;
                    if (checkedItemAdapter == null) {
                        checkedItemAdapter = new CheckedItemAdapter(this.mContext, i7, R.id.text1, this.mItems);
                    }
                }
            }
            ...
            if (this.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: android.support.v7.app.AlertController.AlertParams.3
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i8, long j7) {
                        AlertParams.this.mOnClickListener.onClick(alertController.mDialog, i8);
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: android.support.v7.app.AlertController.AlertParams.4
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i8, long j7) {
                        ...
                        AlertParams.this.mOnCheckboxClickListener.onClick(alertController.mDialog, i8, recycleListView.isItemChecked(i8));
                    }
                });
            }
        ...
        public void apply(AlertController alertController) {
            ...
            if (view != null) {
                ...
                int i7 = this.mIconId;
                if (i7 != 0) {
                    alertController.setIcon(i7);
                }
                int i8 = this.mIconAttrId;
                if (i8 != 0) {
                    alertController.setIcon(alertController.getIconAttributeResId(i8));
                }
            }
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0308R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0308R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0308R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C0308R.styleable.AlertDialog, C0308R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = typedArrayObtainStyledAttributes.getResourceId(C0308R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = typedArrayObtainStyledAttributes.getResourceId(C0308R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = typedArrayObtainStyledAttributes.getResourceId(C0308R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0308R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0308R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0308R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = typedArrayObtainStyledAttributes.getBoolean(C0308R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0308R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private int selectContentView() {
        ...
        return i7 == 0 ? this.mAlertDialogLayout : this.mButtonPanelLayoutHint == 1 ? i7 : this.mAlertDialogLayout;
    }

    private void setScrollIndicators(ViewGroup viewGroup, View view, int i7, int i8) {
        final View viewFindViewById = this.mWindow.findViewById(C0308R.id.scrollIndicatorUp);
        final View viewFindViewById2 = this.mWindow.findViewById(C0308R.id.scrollIndicatorDown);
        ...
        if (viewFindViewById != null && (i7 & 1) == 0) {
            viewGroup.removeView(viewFindViewById);
            viewFindViewById = null;
        }
        if (viewFindViewById2 != null && (i7 & 2) == 0) {
            viewGroup.removeView(viewFindViewById2);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0308R.id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0308R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0308R.id.title_template).setVisibility(8);
            return;
        }
        ...
        TextView textView = (TextView) this.mWindow.findViewById(C0308R.id.alertTitle);
    ...
    private void setupView() {
        ...
        View viewFindViewById3 = this.mWindow.findViewById(C0308R.id.parentPanel);
        int i7 = C0308R.id.topPanel;
        View viewFindViewById4 = viewFindViewById3.findViewById(i7);
        int i8 = C0308R.id.contentPanel;
        View viewFindViewById5 = viewFindViewById3.findViewById(i8);
        int i9 = C0308R.id.buttonPanel;
        View viewFindViewById6 = viewFindViewById3.findViewById(i9);
        ViewGroup viewGroup = (ViewGroup) viewFindViewById3.findViewById(C0308R.id.customPanel);
        ...
        if (!z8 && viewGroupResolvePanel2 != null && (viewFindViewById2 = viewGroupResolvePanel2.findViewById(C0308R.id.textSpacerNoButtons)) != null) {
        ...
        if (z7 != 0) {
            ...
            View viewFindViewById10 = (this.mMessage == null && this.mListView == null) ? null : viewGroupResolvePanel.findViewById(C0308R.id.titleDividerNoCustom);
            if (viewFindViewById10 != null) {
                viewFindViewById10.setVisibility(0);
            }
        } else if (viewGroupResolvePanel2 != null && (viewFindViewById = viewGroupResolvePanel2.findViewById(C0308R.id.textSpacerNoTitle)) != null) {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0308R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public void setButtonPanelLayoutHint(int i7) {
        this.mButtonPanelLayoutHint = i7;
    }
    ...
    public void setView(View view, int i7, int i8, int i9, int i10) {
        ...
        this.mViewSpacingLeft = i7;
        this.mViewSpacingTop = i8;
        this.mViewSpacingRight = i9;

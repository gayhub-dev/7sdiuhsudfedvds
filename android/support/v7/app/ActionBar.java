...
public abstract class ActionBar {
    ...
    public interface OnNavigationListener {
        boolean onNavigationItemSelected(int i7, long j7);
    }
    ...
    public static abstract class Tab {
        ...
        public abstract Tab setContentDescription(@StringRes int i7);

        public abstract Tab setContentDescription(CharSequence charSequence);

        public abstract Tab setCustomView(int i7);

        public abstract Tab setCustomView(View view);

        public abstract Tab setIcon(@DrawableRes int i7);
        ...
        public abstract Tab setText(int i7);
    ...
    @Deprecated
    public abstract void addTab(Tab tab, int i7);

    @Deprecated
    public abstract void addTab(Tab tab, int i7, boolean z6);
    ...
    @Deprecated
    public abstract Tab getTabAt(int i7);
    ...
    @Deprecated
    public abstract void removeTabAt(int i7);
    ...
    public abstract void setCustomView(int i7);
    ...
    public abstract void setDisplayOptions(int i7);

    public abstract void setDisplayOptions(int i7, int i8);
    ...
    public void setHomeActionContentDescription(@StringRes int i7) {
    }

    public void setHomeActionContentDescription(@Nullable CharSequence charSequence) {
    }

    public void setHomeAsUpIndicator(@DrawableRes int i7) {
    }
    ...
    public abstract void setIcon(@DrawableRes int i7);
    ...
    public abstract void setLogo(@DrawableRes int i7);

    public abstract void setLogo(Drawable drawable);

    @Deprecated
    public abstract void setNavigationMode(int i7);

    @Deprecated
    public abstract void setSelectedNavigationItem(int i7);
    ...
    public abstract void setTitle(@StringRes int i7);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0308R.styleable.ActionBarLayout);
            this.gravity = typedArrayObtainStyledAttributes.getInt(C0308R.styleable.ActionBarLayout_android_layout_gravity, 0);

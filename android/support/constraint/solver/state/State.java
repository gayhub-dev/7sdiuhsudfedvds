...
public class State {
    ...
    public static /* synthetic */ class C00861 {
        public static final /* synthetic */ int[] $SwitchMap$android$support$constraint$solver$state$State$Helper;
    ...
    private String createHelperKey() {
        StringBuilder sbM112a = C0413b.m112a("__HELPER_KEY_");
        int i7 = this.numHelpers;
        this.numHelpers = i7 + 1;
        return C0084a.m96a(sbM112a, i7, "__");
    }
    ...
    public GuidelineReference guideline(Object obj, int i7) {
        Reference reference = this.mReferences.get(obj);
        Reference reference2 = reference;
        if (reference == null) {
            GuidelineReference guidelineReference = new GuidelineReference(this);
            guidelineReference.setOrientation(i7);
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference == null) {
            int i7 = C00861.$SwitchMap$android$support$constraint$solver$state$State$Helper[helper.ordinal()];
            if (i7 == 1) {

...
public class ConstraintReference implements Reference {
    ...
    public static /* synthetic */ class C00851 {
        ...
        public static final /* synthetic */ int[] f134xc4a3d897;
        ...
        static {
            ...
            try {
                f134xc4a3d897[State.Constraint.LEFT_TO_RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f134xc4a3d897[State.Constraint.RIGHT_TO_LEFT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f134xc4a3d897[State.Constraint.RIGHT_TO_RIGHT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f134xc4a3d897[State.Constraint.START_TO_START.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f134xc4a3d897[State.Constraint.START_TO_END.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f134xc4a3d897[State.Constraint.END_TO_START.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f134xc4a3d897[State.Constraint.END_TO_END.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f134xc4a3d897[State.Constraint.TOP_TO_TOP.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f134xc4a3d897[State.Constraint.TOP_TO_BOTTOM.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f134xc4a3d897[State.Constraint.BOTTOM_TO_TOP.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f134xc4a3d897[State.Constraint.BOTTOM_TO_BOTTOM.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f134xc4a3d897[State.Constraint.BASELINE_TO_BASELINE.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f134xc4a3d897[State.Constraint.CENTER_HORIZONTALLY.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f134xc4a3d897[State.Constraint.CENTER_VERTICALLY.ordinal()] = 15;
    ...
    public class IncorrectConstraintException extends Exception {
        ...
        public String toString() {
            StringBuilder sbM112a = C0413b.m112a("IncorrectConstraintException: ");
            sbM112a.append(this.mErrors.toString());
    ...
    public void apply() {
        ...
        int i7 = this.mHorizontalChainStyle;
        if (i7 != 0) {
            this.mConstraintWidget.setHorizontalChainStyle(i7);
        }
        int i8 = this.mVerticalChainStyle;
        if (i8 != 0) {
            this.mConstraintWidget.setVerticalChainStyle(i8);
        }
    ...
    public ConstraintReference bias(float f7) {
        State.Constraint constraint = this.mLast;
        if (constraint == null) {
            return this;
        }
        switch (C00851.f134xc4a3d897[constraint.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    public int getVerticalChainStyle(int i7) {
    ...
    public ConstraintReference horizontalBias(float f7) {
        this.mHorizontalBias = f7;
        return this;
    }
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public ConstraintReference marginGone(int i7) {
        State.Constraint constraint = this.mLast;
        if (constraint != null) {
            switch (C00851.f134xc4a3d897[constraint.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeftGone = i7;
                    break;
                case 3:
                case 4:
                    this.mMarginRightGone = i7;
                    break;
                case 5:
                case 6:
                    this.mMarginStartGone = i7;
                    break;
                case 7:
                case 8:
                    this.mMarginEndGone = i7;
                    break;
                case 9:
                case 10:
                    this.mMarginTopGone = i7;
                    break;
                case 11:
                case 12:
                    this.mMarginBottomGone = i7;
                    break;
            }
        } else {
            this.mMarginLeftGone = i7;
    ...
    public ConstraintReference verticalBias(float f7) {
        this.mVerticalBias = f7;
        return this;
    }
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public ConstraintReference margin(int i7) {
        State.Constraint constraint = this.mLast;
        if (constraint != null) {
            switch (C00851.f134xc4a3d897[constraint.ordinal()]) {
                case 1:

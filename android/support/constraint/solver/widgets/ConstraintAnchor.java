...
public class ConstraintAnchor {
    ...
    public static /* synthetic */ class C00901 {
        ...
        static {
            ...
            try {
                f136x1d400623[Type.LEFT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f136x1d400623[Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f136x1d400623[Type.TOP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f136x1d400623[Type.BOTTOM.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f136x1d400623[Type.BASELINE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f136x1d400623[Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f136x1d400623[Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f136x1d400623[Type.NONE.ordinal()] = 9;
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i7, int i8, boolean z6) {
    ...
    public void findDependents(int i7, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        HashSet<ConstraintAnchor> hashSet = this.mDependents;
        if (hashSet != null) {
            Iterator<ConstraintAnchor> it = hashSet.iterator();
            while (it.hasNext()) {
                Grouping.findDependents(it.next().mOwner, i7, arrayList, widgetGroup);
            }
        }
    }
    ...
    public final ConstraintAnchor getOpposite() {
        switch (C00901.f136x1d400623[this.mType.ordinal()]) {
            case 1:
            case 6:
            case 7:
            case 8:
    ...
    public boolean isSimilarDimensionConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (C00901.f136x1d400623[type2.ordinal()]) {
            case 1:
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i7) {
        return connect(constraintAnchor, i7, -1, false);
    }
}

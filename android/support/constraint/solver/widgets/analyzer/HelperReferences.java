    ...
    public void apply() {
        ...
        if (constraintWidget instanceof Barrier) {
            ...
            if (barrierType == 0) {
                ...
                while (i7 < barrier.mWidgetsCount) {
                    ConstraintWidget constraintWidget2 = barrier.mWidgets[i7];
            ...
            if (barrierType == 1) {
                ...
                while (i7 < barrier.mWidgetsCount) {
                    ConstraintWidget constraintWidget3 = barrier.mWidgets[i7];
            ...
            while (i7 < barrier.mWidgetsCount) {
                ConstraintWidget constraintWidget5 = barrier.mWidgets[i7];

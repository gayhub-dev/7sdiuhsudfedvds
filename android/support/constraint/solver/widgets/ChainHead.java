...
public class ChainHead {
    ...
    private void defineChainProperties() {
        ...
        while (!z6) {
            ...
            constraintWidget.mListNextMatchConstraintsWidget[i8] = null;
            if (constraintWidget.getVisibility() != 8) {
                ...
                int margin = constraintWidget.mListAnchors[i7].getMargin() + this.mTotalSize;
                this.mTotalSize = margin;
                int i9 = i7 + 1;
                this.mTotalSize = constraintWidget.mListAnchors[i9].getMargin() + margin;
                int margin2 = constraintWidget.mListAnchors[i7].getMargin() + this.mTotalMargins;
                this.mTotalMargins = margin2;
                this.mTotalMargins = constraintWidget.mListAnchors[i9].getMargin() + margin2;
        ...
        if (constraintWidget6 != null) {
            this.mTotalSize -= constraintWidget6.mListAnchors[i7].getMargin();
        }
        ConstraintWidget constraintWidget7 = this.mLastVisibleWidget;
        if (constraintWidget7 != null) {
            this.mTotalSize -= constraintWidget7.mListAnchors[i7 + 1].getMargin();
        }
    ...
    private static boolean isMatchConstraintEqualityCandidate(ConstraintWidget constraintWidget, int i7) {

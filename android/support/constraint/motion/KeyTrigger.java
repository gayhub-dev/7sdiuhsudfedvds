...
public class KeyTrigger extends Key {
    ...
    public static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0071R.styleable.KeyTrigger_framePosition, 8);
            mAttrMap.append(C0071R.styleable.KeyTrigger_onCross, 4);
            mAttrMap.append(C0071R.styleable.KeyTrigger_onNegativeCross, 1);
            mAttrMap.append(C0071R.styleable.KeyTrigger_onPositiveCross, 2);
            mAttrMap.append(C0071R.styleable.KeyTrigger_motionTarget, 7);
            mAttrMap.append(C0071R.styleable.KeyTrigger_triggerId, 6);
            mAttrMap.append(C0071R.styleable.KeyTrigger_triggerSlack, 5);
            mAttrMap.append(C0071R.styleable.KeyTrigger_motion_triggerOnCollision, 9);
            mAttrMap.append(C0071R.styleable.KeyTrigger_motion_postLayoutCollision, 10);
            mAttrMap.append(C0071R.styleable.KeyTrigger_triggerReceiver, 11);
        }
    ...
    public KeyTrigger() {
        int i7 = Key.UNSET;
        this.mTriggerReceiver = i7;
        this.mNegativeCross = null;
        this.mPositiveCross = null;
        this.mTriggerID = i7;
        this.mTriggerCollisionId = i7;
    ...
    */
    public void conditionallyFire(float r9, android.view.View r10) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        /*
            Method dump skipped, instructions count: 398
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.constraint.motion.KeyTrigger.conditionallyFire(float, android.view.View):void");
    }
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0071R.styleable.KeyTrigger), context);
    }

...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return C0072a.m92a(new StringBuilder(), Utils.typeToString(this.componentType), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            for (int i7 = 1; i7 < this.typeArguments.length; i7++) {
                sb.append(", ");
                sb.append(Utils.typeToString(this.typeArguments[i7]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class WildcardTypeImpl implements WildcardType {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder sbM112a = C0413b.m112a("? super ");
                sbM112a.append(Utils.typeToString(this.lowerBound));
                return sbM112a.toString();
            }
            if (this.upperBound == Object.class) {
                return "?";
            }
            StringBuilder sbM112a2 = C0413b.m112a("? extends ");
            sbM112a2.append(Utils.typeToString(this.upperBound));
    ...
    public static <T> T checkNotNull(@Nullable T t6, String str) {
    ...
    public static Type getGenericSupertype(Type type, Class<?> cls, Class<?> cls2) {
        ...
        if (cls2.isInterface()) {
            ...
            for (int i7 = 0; i7 < length; i7++) {
                if (interfaces[i7] == cls2) {
                    return cls.getGenericInterfaces()[i7];
                }
                if (cls2.isAssignableFrom(interfaces[i7])) {
    ...
    public static Type getParameterUpperBound(int i7, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbM98a = C0116a.m98a("Index ", i7, " not in range [0,");
        sbM98a.append(actualTypeArguments.length);
        sbM98a.append(") for ");
        sbM98a.append(parameterizedType);
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i7, String str, Object... objArr) {
        StringBuilder sbM94a = C0080b.m94a(str, " (parameter #");
        sbM94a.append(i7 + 1);
        sbM94a.append(")");
        return methodError(method, th, sbM94a.toString(), objArr);
    }
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if (type3 instanceof ParameterizedType) {
            ...
            boolean z6 = typeResolve3 != ownerType;
            Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
            int length = actualTypeArguments.length;
            for (int i7 = 0; i7 < length; i7++) {
                Type typeResolve4 = resolve(type, cls, actualTypeArguments[i7]);
                if (typeResolve4 != actualTypeArguments[i7]) {
                    if (!z6) {
            ...
            return z6 ? new ParameterizedTypeImpl(typeResolve3, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
        }
        boolean z7 = type3 instanceof WildcardType;
        Type type4 = type3;
        if (z7) {
    ...
    public static RuntimeException methodError(Method method, @Nullable Throwable th, String str, Object... objArr) {
        StringBuilder sbM94a = C0080b.m94a(String.format(str, objArr), "\n    for method ");
        sbM94a.append(method.getDeclaringClass().getSimpleName());
        sbM94a.append(".");
        sbM94a.append(method.getName());
        return new IllegalArgumentException(sbM94a.toString(), th);
    }

    public static RuntimeException parameterError(Method method, int i7, String str, Object... objArr) {
        StringBuilder sbM94a = C0080b.m94a(str, " (parameter #");
        sbM94a.append(i7 + 1);
        sbM94a.append(")");
        return methodError(method, sbM94a.toString(), objArr);
    }
}

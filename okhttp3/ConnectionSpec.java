...
public final class ConnectionSpec {
    ...
    private ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z6) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        boolean z6 = this.tls;
        if (z6 != connectionSpec.tls) {
            return false;
        }
        return !z6 || (Arrays.equals(this.cipherSuites, connectionSpec.cipherSuites) && Arrays.equals(this.tlsVersions, connectionSpec.tlsVersions) && this.supportsTlsExtensions == connectionSpec.supportsTlsExtensions);
    }
    ...
    public static final class Builder {
        ...
        public Builder supportsTlsExtensions(boolean z6) {
            if (!this.tls) {

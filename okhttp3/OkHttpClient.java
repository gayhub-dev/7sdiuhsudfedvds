...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder callTimeout(long j7, TimeUnit timeUnit) {
            this.callTimeout = Util.checkDuration("timeout", j7, timeUnit);
            return this;
        }
        ...
        public Builder connectTimeout(long j7, TimeUnit timeUnit) {
            this.connectTimeout = Util.checkDuration("timeout", j7, timeUnit);
            return this;
        }
        ...
        public Builder pingInterval(long j7, TimeUnit timeUnit) {
            this.pingInterval = Util.checkDuration("interval", j7, timeUnit);
            return this;
        }
        ...
        public Builder readTimeout(long j7, TimeUnit timeUnit) {
            this.readTimeout = Util.checkDuration("timeout", j7, timeUnit);
            return this;
        }
        ...
        public Builder writeTimeout(long j7, TimeUnit timeUnit) {
            this.writeTimeout = Util.checkDuration("timeout", j7, timeUnit);
            return this;
        }
    ...
    static {
        Internal.instance = new Internal() { // from class: okhttp3.OkHttpClient.1
            ...
            public void apply(ConnectionSpec connectionSpec, SSLSocket sSLSocket, boolean z6) {
                connectionSpec.apply(sSLSocket, z6);
            }
    ...
    public OkHttpClient(Builder builder) {
        ...
        if (this.interceptors.contains(null)) {
            StringBuilder sbM112a = C0413b.m112a("Null interceptor: ");
            sbM112a.append(this.interceptors);
            throw new IllegalStateException(sbM112a.toString());
        }
        if (this.networkInterceptors.contains(null)) {
            StringBuilder sbM112a2 = C0413b.m112a("Null network interceptor: ");
            sbM112a2.append(this.networkInterceptors);

...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private static List<String> getSubjectAltNames(X509Certificate x509Certificate, int i7) throws CertificateParsingException {
        Integer num;
        String str;
    ...
    private boolean verifyIpAddress(String str, X509Certificate x509Certificate) throws CertificateParsingException {
        ...
        for (int i7 = 0; i7 < size; i7++) {
            if (str.equalsIgnoreCase(subjectAltNames.get(i7))) {
                return true;
            }
        }
        return false;

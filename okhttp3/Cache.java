...
public final class Cache implements Closeable, Flushable {
    ...
    public class C15971 implements InternalCache {
        public C15971() {
        }
    ...
    public class C15982 implements Iterator<String> {
    ...
    public final class CacheRequestImpl implements CacheRequest {
        ...
        public CacheRequestImpl(DiskLruCache.Editor editor) {
            ...
            this.body = new ForwardingSink(sinkNewSink) { // from class: okhttp3.Cache.CacheRequestImpl.1
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C15991(Sink sinkNewSink2, Cache cache, DiskLruCache.Editor editor2) {
                    super(sinkNewSink2);
                    cache = cache;
                    editor = editor2;
                }
    ...
    public static class CacheResponseBody extends ResponseBody {
        ...
        public class C16001 extends ForwardingSource {
            public final /* synthetic */ DiskLruCache.Snapshot val$snapshot;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C16001(Source source, DiskLruCache.Snapshot snapshot) {
                super(source);
                snapshot = snapshot;
            }
        ...
        public CacheResponseBody(DiskLruCache.Snapshot snapshot, String str, String str2) {
            ...
            this.bodySource = Okio.buffer(new ForwardingSource(snapshot.getSource(1)) { // from class: okhttp3.Cache.CacheResponseBody.1
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C16001(Source source, DiskLruCache.Snapshot snapshot2) {
                    super(source);
                    snapshot = snapshot2;
                }
    ...
    public static final class Entry {
        ...
        public Entry(Source source) {
            try {
                ...
                int i7 = Cache.readInt(bufferedSourceBuffer);
                ...
                int i9 = Cache.readInt(bufferedSourceBuffer);
        ...
        private List<Certificate> readCertificateList(BufferedSource bufferedSource) throws IOException, CertificateException {
            int i7 = Cache.readInt(bufferedSource);
            if (i7 == -1) {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                for (int i7 = 0; i7 < size; i7++) {
                    bufferedSink.writeUtf8(ByteString.m1869of(list.get(i7).getEncoded()).base64()).writeByte(10);
                }
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                bufferedSinkBuffer.writeUtf8(this.varyHeaders.name(i7)).writeUtf8(": ").writeUtf8(this.varyHeaders.value(i7)).writeByte(10);
            }
            ...
            for (int i8 = 0; i8 < size2; i8++) {
                bufferedSinkBuffer.writeUtf8(this.responseHeaders.name(i8)).writeUtf8(": ").writeUtf8(this.responseHeaders.value(i8)).writeByte(10);
            }

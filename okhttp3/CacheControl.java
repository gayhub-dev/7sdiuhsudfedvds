...
public final class CacheControl {
    ...
    public static final class Builder {
        ...
        public Builder maxAge(int i7, TimeUnit timeUnit) {
            if (i7 < 0) {
                throw new IllegalArgumentException(C0079a.m93a("maxAge < 0: ", i7));
            }
        ...
        public Builder maxStale(int i7, TimeUnit timeUnit) {
            if (i7 < 0) {
                throw new IllegalArgumentException(C0079a.m93a("maxStale < 0: ", i7));
            }
            long seconds = timeUnit.toSeconds(i7);
        ...
        public Builder minFresh(int i7, TimeUnit timeUnit) {
            if (i7 < 0) {
                throw new IllegalArgumentException(C0079a.m93a("minFresh < 0: ", i7));
            }
            long seconds = timeUnit.toSeconds(i7);

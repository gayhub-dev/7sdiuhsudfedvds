...
public class IjkMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public IjkStreamMeta(int i7) {
            this.mIndex = i7;
        }

        public String getBitrateInline() {
            long j7 = this.mBitrate;
        ...
        public String getFpsInline() {
            int i7;
            int i8 = this.mFpsNum;
            return (i8 <= 0 || (i7 = this.mFpsDen) <= 0) ? "N/A" : String.valueOf(i8 / i7);
        }
        ...
        public String getResolutionInline() {
            int i7 = this.mWidth;
            return (i7 <= 0 || this.mHeight <= 0) ? "N/A" : (this.mSarNum <= 0 || this.mSarDen <= 0) ? String.format(Locale.US, "%d x %d", Integer.valueOf(i7), Integer.valueOf(this.mHeight)) : String.format(Locale.US, "%d x %d [SAR %d:%d]", Integer.valueOf(i7), Integer.valueOf(this.mHeight), Integer.valueOf(this.mSarNum), Integer.valueOf(this.mSarDen));
        }
    ...
    public static IjkMediaMeta parse(Bundle bundle) {
        ...
        int i7 = -1;
        int i8 = ijkMediaMeta.getInt("video", -1);
        int i9 = ijkMediaMeta.getInt("audio", -1);
        ...
        while (it.hasNext()) {
            ...
            i7++;
            if (next != null) {
                IjkStreamMeta ijkStreamMeta = new IjkStreamMeta(i7);
    ...
    public String getDurationInline() {
        long j7 = (this.mDurationUS + 5000) / 1000000;
        long j8 = j7 / 60;

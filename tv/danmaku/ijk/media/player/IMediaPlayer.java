...
public interface IMediaPlayer {
    ...
    public interface OnAudioVividMetadataListener {
    ...
    public interface OnInfoListener {
        boolean onInfo(IMediaPlayer iMediaPlayer, int i7, Object obj);
    }

    public interface OnMpegTsPesPrivateDataListener {
        void onPesPrivateData(IMediaPlayer iMediaPlayer, PesPrivateDataTimeStamp pesPrivateDataTimeStamp);
    }
    ...
    public interface OnSEIRefreshListener {
        void onSEIRefresh(IMediaPlayer iMediaPlayer, int i7, int i8);
    }
    ...
    public interface OnVideoSizeChangedListener {
        void onVideoSizeChanged(IMediaPlayer iMediaPlayer, int i7, int i8, int i9, int i10);
    }

    float getAudioFrameSpeed();

    int getAudioSessionId();

    float getAv3aMetadataFloat(int i7, int i8);

    int getAv3aMetadataInt(int i7, int i8);

    String getAv3aMetadataString(int i7, int i8);
    ...
    int setAv3aMetadataFloat(int i7, int i8, float f7);
    ...
    void setEnableHdrVivid(boolean z6);
    ...
    void setOnMpegTsPesPrivateDataListener(OnMpegTsPesPrivateDataListener onMpegTsPesPrivateDataListener);

...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    public class AndroidMediaPlayerListenerHolder implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnTimedTextListener {
        ...
        public void onBufferingUpdate(MediaPlayer mediaPlayer, int i7) {
            ...
            AndroidMediaPlayer.this.notifyOnBufferingUpdate(i7);
        }
        ...
        public boolean onError(MediaPlayer mediaPlayer, int i7, int i8) {
            return this.mWeakMediaPlayer.get() != null && AndroidMediaPlayer.this.notifyOnError(i7, i8);
        }

        @Override // android.media.MediaPlayer.OnInfoListener
        public boolean onInfo(MediaPlayer mediaPlayer, int i7, int i8) {
            return this.mWeakMediaPlayer.get() != null && AndroidMediaPlayer.this.notifyOnInfo(i7, Integer.valueOf(i8));
        }
        ...
        public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i7, int i8) {
            ...
            AndroidMediaPlayer.this.notifyOnVideoSizeChanged(i7, i8, 1, 1);
        }
    }
    ...
    public static class MediaDataSourceProxy extends MediaDataSource {
        ...
        public int readAt(long j7, byte[] bArr, int i7, int i8) {
            return this.mMediaDataSource.readAt(j7, bArr, i7, i8);
        }
    }
    ...
    public void seekTo(long j7) throws IllegalStateException {
        this.mInternalMediaPlayer.seekTo((int) j7);
    }
    ...
    public void setLooping(boolean z6) {
        this.mInternalMediaPlayer.setLooping(z6);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setScreenOnWhilePlaying(boolean z6) {
        this.mInternalMediaPlayer.setScreenOnWhilePlaying(z6);
    }
    ...
    public void setVolume(float f7, float f8) {
        this.mInternalMediaPlayer.setVolume(f7, f8);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setWakeMode(Context context, int i7) {
        this.mInternalMediaPlayer.setWakeMode(context, i7);
    }
